...
<table width="100%" border="0" cellpadding="0" cellspacing="1" >
  ...
  <tr>
	...
	<p align="left">
	  Customers Name <br> 
        <span class="style1">First</span>        <input name="fname" type="text" id="fname" value="#Fname#" readonly="yes">

         <span class="style1">Last</span>         <input name="lname" type="text" id="lname" value="#Lname#" readonly="yes">
	     </p>
	<p align="left">Scheduled Date: 
	  <input name="sdate" type="text" id="sdate" size="10" maxlength="10" value="#dateformat(actualdate,'m/d/yyyy')#" readonly="yes">
	  </p>
	<p align="left"><span class="style1"><em><strong>RESCHEDULED DATE</strong></em></span>: 
	  <cfinput name="resch" type="text" id="resch" value="" size="10" maxlength="10" required="yes" validate="date" message="You must enter in a valid date" >
	  <br>
	           </p>
	<p>
     <input name="update" type="submit" id="update" value="Re-Schedule Customer" >
</p>
