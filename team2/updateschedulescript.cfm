...
UPDATE master SET actualdate='#form.resch#' WHERE ID=#ID#
</cfquery>
<cfoutput>
<p>Customer #Form.lname#, #Form.fname# has been updated<br>
...
The following User has been rescheduled by Team 2 Admin
...
Name: #FORM.lname#, #FORM.fname#
Date and Time: #FORM.resch# 
</cfmail>


<meta http-equiv="refresh" content="2;URL=./search.cfm">
