...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                ...
                <div align="center">
                  <p><span class="burgundy"><strong>Welcome<br>
                    Migration Team 2 </strong></span><span class="burgundy"><strong><br>
                      <strong>What would you like to do today?</strong> </strong></span>                    <br>
                    </p>
                  </div>
                <table width="100%"  border="0" cellpadding="10" cellspacing="10">
                  <tr>
                    <td align="center" valign="top" bgcolor="#eeeeee" class="style2 style4"><strong><a href="team2.cfm" target="_blank">Enter Times</a></strong></td>
                    <td align="center" valign="top" bgcolor="#eeeeee" class="style4 style2"><strong><a href="../issue/migrationissue.cfm" target="_blank">Report an Issue</a></strong></td>
                  </tr>
                  <tr>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee" class="style2 style4"><strong><a href="search.cfm">Re-Schedule Customer </a></strong></td>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee" class="style2 style4"><strong><a href="wschedule.cfm">Create Weekly Schedule </a></strong></td>
                  </tr>
                  <tr>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee" class="style2 style4"><strong><a href="currentweek.cfm">View Current Weeks Schedule</a> </strong></td>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee" class="burgundy"><a href="cancel.cfm" target="_blank"><strong>Cancel Migration </strong></a></td>
                  </tr>
                </table>
