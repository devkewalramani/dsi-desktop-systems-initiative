<cfset total=#FORM.t1#+#FORM.t2#+#FORM.t3#+#FORM.t4#+#FORM.t5#+#FORM.t6#+#FORM.t7#+#FORM.t8#+#FORM.t9#+#FORM.t10#+#FORM.t11#+#FORM.t12#>


<cfquery name="submit" datasource="DSI">
INSERT INTO teamtwo (midate,fname,lname,tech,type,model,status,preextract,addtogroup,extraction,swaphw,firstboot,injection,smsclient,groupremoval,userlogin,postmi,userverifi,other,tot,comments) VALUES('#FORM.Date#','#FORM.fname#','#FORM.lname#','#FORM.tech#','#FORM.type#','#FORM.model#','#FORM.status#','#FORM.t1#','#FORM.t2#','#FORM.t3#','#FORM.t4#','#FORM.t5#','#FORM.t6#','#FORM.t7#','#FORM.t8#','#FORM.t9#','#FORM.t10#','#FORM.t11#','#FORM.t12#','#total#','#FORM.comments#')
</cfquery>
<cfset total=#FORM.t1#+#FORM.t2#+#FORM.t3#+#FORM.t4#+#FORM.t5#+#FORM.t6#+#FORM.t7#+#FORM.t8#+#FORM.t9#+#FORM.t10#+#FORM.t11#+#FORM.t12#>
...
<meta http-equiv="refresh" content="1;URL=team2.cfm">
...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                <td valign="top"><!-- InstanceBeginEditable name="mainbody" -->
                  <p>Your times were reported successfully! <br>
                    Please wait to be re-directed!</p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
