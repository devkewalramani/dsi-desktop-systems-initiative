...
<table width="100%" border="0" cellpadding="0" cellspacing="1" >
  ...
  <tr>
    ...
    <td width="603" height="408" align="left" valign="top">
	<!--display information-->
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	<tr>
        <td width="8%"><span class="style1 style5">ID&nbsp;</a></span></td>
		<td width="18%"><span class="style1 style5">Name&nbsp;</span></td>
        <td width="12%"><span class="style1 style5 style5">Function</span></td>
        <td width="9%"><span class="style1 style5 style5">S-Date&nbsp;</span></td>
        <td width="11%"><span class="style1 style5 style5">Time</span></td>
        <td width="12%"><span class="style1 style5 style5">flr</span></td>
        <td width="11%"><span class="style1 style5 style5">Type</span></td>
        <td width="19%"><span class="style1 style5 style5">&nbsp;Status</span></td>
		<br>
      </tr></table>
	<cfoutput query="lookup">
	<table width="100%"  border="1" cellspacing="0" cellpadding="0">
      <tr>
        <td width="36"><a href="cancelmigration.cfm?recordID=#ID#" class="style5">#ID#</a></td>
		<td width="110"><span class="style5">#lname#,#fname#&nbsp;</span></td>
        <td width="56"><span class="style5">#func#&nbsp;</span></td>
		 <td width="56"><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span></td>
		 <td width="56"><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span></td>
		 <td width="56"><span class="style5">#flr#&nbsp;</span></td>
		<td width="65"><span class="style5">#mtype#&nbsp;</span></td>
		<td width="61"><span class="style5">#dispo#&nbsp;</span></td>
		<td width="50"><span class="style5">#status#&nbsp;</span></td>
