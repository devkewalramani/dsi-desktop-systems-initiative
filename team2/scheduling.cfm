...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                ...
                <table width="100%"  border="0" cellpadding="10" cellspacing="10">
                  <tr>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee"><span class="style2 style4"><strong><a href="search.cfm">Re-Schedule Customer </a></strong></span></td>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee"><span class="style2 style4"><strong><a href="wschedule.cfm">Create Weekly Schedule </a></strong></span></td>
                  </tr>
                  <tr>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee"><span class="style2 style4"><strong><a href="currentweek.cfm">View Current Weeks Schedule</a> </strong></span></td>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee"><span class="burgundy"><a href="cancel.cfm" target="_blank"><strong>Cancel Migration </strong></a></span></td>
                  </tr>
                  <tr>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee"><span class="style4"></span></td>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee"><span class="style4"></span></td>
                  </tr>
                </table>
