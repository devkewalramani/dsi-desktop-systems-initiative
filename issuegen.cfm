...
<table width="715" height="385" border="0" cellpadding="0" cellspacing="1" >
  <tr>
    <td width="709" valign="top"> 
      <table width="712" border="0" cellpadding="0" cellspacing="0" >
      <tr>
          <td width="200" valign="top" bgcolor="#eeeeee">&nbsp;</td>
        <td width="507" bgcolor="#EEEEEE"><font color="#652219" size='+2'>DSI Migration Issue Log Report System</font></td>
      </tr>
    </table><table width="632" height="314" border="0" cellpadding="0" cellspacing="1" >
  <tr>
    <td width="153" align="left" valign="top" bgcolor="#EEEEEE"><br>      <table width="42%" height="278"  border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td align="center" valign="top"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22">
          ...
          <param name="movie" value="range1.swf">
          <param name="quality" value="high">
          <embed src="range1.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
        </object></td>
      </tr>
      <tr>
        <td align="center" valign="top"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22">
          <param name="BGCOLOR" value="">
          <param name="movie" value="range2.swf">
          <param name="quality" value="high">
          <embed src="range2.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
        </object></td>
      </tr>
      <tr>
        <td align="center" valign="top"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22">
          <param name="BGCOLOR" value="">
          <param name="movie" value="range3.swf">
          <param name="quality" value="high">
          <embed src="range3.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
        </object></td>
      </tr>
      <tr>
	...
	<!--display information-->
	<form name="range" method="post" action="issuelogreport.cfm">
  <p>
  ...
  if (!document.layers) {
  document.write("<input type=button onclick='popUpCalendar(this, range.bdate, \"m/d/yyyy\")' value='select'  style='font-size:11px'>")
  }
</script>
  <br>
  ...
  <script language='javascript'>
  if (!document.layers) {
  document.write("<input type=button onclick='popUpCalendar(this, range.edate, \"m/d/yyyy\")' value='select'  style='font-size:11px'>")
  }
  </script>
    <br>
	Select a Status:
