...
<div align="center">
  <p class="burgundy"><strong>DSI<br>
    Customer Detail View
</strong></p>
  </div>
<span class="burgundy"><strong><cfoutput query="detail"></cfoutput></strong></span><cfoutput query="detail">
...
<table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="##cccccc">
  <tr bgcolor="##eeeeee" class="burgundy">
    ...
    <th scope="col">Re-Scheduled Date </th>
    <th scope="col">Migration Time </th>
    <th scope="col">Orientation Date </th>
    <th scope="col">XP Training Date </th>
  </tr>
  <tr bgcolor="##FFFFFF">
    <td>#dateformat(midate,'m/d/yyyy')#</td>
