...
<cfform name="form" method="post" action="team2pass.cfm" enctype="application/x-www-form-urlencoded">
  <p align="center" class="burgundy style1"><strong>
  You are accessing a<br>
  restricted page!
  ...
  <hr width="100%" noshade>
    ...
    <p align="center">
  Please Enter Your Admin Password</p>
    <p align="center">      <cfinput type="password" name="pass" required="yes" message="You Need to Enter your Team 2 Password">
    </p>
    <p align="center">
