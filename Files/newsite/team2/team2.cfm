...
<cfquery name="techlookup" datasource="newdsi">
Select *
From techs
Where team='2' OR team='3' OR team='4'
Order by lname ASC
</cfquery>
...
<p>
  ...
  <select name="tech" id="tech">
     <option value=""></option>
     <cfoutput query="techlookup">
     <option value="#lname#">#lname#,#fname#</option>
     </cfoutput>
    </select>
          </label>
</p>
...
A. Pre Extraction Verification:
      <input name="t1" type="text" id="t1" tabindex="1" value="0" size="5" maxlength="5">
	  <br>
       <!--smsclient--><input name="t7" type="hidden" value="0">
	   <!--Add to groups--><input name="t2" type="hidden"  value="0" >
	   <!--group removal--><input name="t8" type="hidden" value="0">
B. Start of Extraction:
      <input name="t3" type="text" id="t3" tabindex="2" value="0" size="5" maxlength="5">
	  <br>
      <!--User Login/Pass change:--><input name="t9" type="hidden" value="0">
      <!--Swap HW:--><input name="t4" type="hidden" value="0">
      <!--1st Boot:--><input name="t5" type="hidden" value="0">
      <!--User verification:--><input name="t11" type="hidden" value="0">
C. Start of Injection:
      <input name="t6" type="text" id="t6" tabindex="3" value="0" size="5" maxlength="5">
	  <br>
D. Post Migration: 
      <input name="t10" type="text" id="t10" tabindex="4" value="0" size="5" maxlength="5">
	  <br>
E: Install of SMS Client:
      <input name="t12" type="text" id="t12" tabindex="5" value="0" size="5" maxlength="5">
	  <br><br>
<p>Comments:<br>
  <textarea name="comments" cols="80" rows="7" id="comments" tabindex="6"></textarea>
</p>
<p>
  <input name="new" type="submit" id="new2" value="Submit" tabindex="7">
  </p>
</form>
