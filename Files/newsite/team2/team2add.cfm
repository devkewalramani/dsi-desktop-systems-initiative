...
<cfquery name="submit" datasource="newdsi">
INSERT INTO teamtwo (midate,fname,lname,tech,type,model,preextract,addtogroup,extraction,swaphw,firstboot,injection,smsclient,groupremoval,userlogin,postmi,userverifi,other,tot,comments) VALUES('#FORM.Date#','#FORM.fname#','#FORM.lname#','#FORM.tech#','#FORM.type#','#FORM.model#','#FORM.t1#','#FORM.t2#','#FORM.t3#','#FORM.t4#','#FORM.t5#','#FORM.t6#','#FORM.t7#','#FORM.t8#','#FORM.t9#','#FORM.t10#','#FORM.t11#','#FORM.t12#','#total#','#FORM.comments#')
</cfquery>
<cfset total=#FORM.t1#+#FORM.t2#+#FORM.t3#+#FORM.t4#+#FORM.t5#+#FORM.t6#+#FORM.t7#+#FORM.t8#+#FORM.t9#+#FORM.t10#+#FORM.t11#+#FORM.t12#>
