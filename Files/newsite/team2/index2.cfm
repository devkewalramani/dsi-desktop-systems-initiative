...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                <td valign="top"><!-- InstanceBeginEditable name="mainbody" -->
				  <p align="center"><span class="style2 style4"><span class="burgundy"><strong>Welcome<br>
  Migration Team 2 </strong></span><span class="burgundy"><strong><br>
  <strong>What would you like to do today?</strong></strong></span></span>
                  </p>
				  <table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#CCCCCC">
                  <tr bgcolor="#EEEEEE">
                    <th colspan="2" align="center" valign="top" class="burgundy">TEAM 2 TOOLS </th>
                    </tr>
                  <tr bgcolor="#FFFFFF">
                    <td align="center" valign="top" class="style2 style4"><strong><a href="team2.cfm" target="_blank">Enter Times</a></strong></td>
                    <td align="center" valign="top" class="style4 style2"><strong><a href="../issue/" target="_blank">Report an Issue</a></strong></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td width="50%" align="center" valign="top" class="style2 style4"><strong><a href="currentweek.cfm">View Current Weeks Schedule</a> </strong></td>
                    <td width="50%" align="center" valign="top" class="style2 style4"><strong><a href="wschedule.cfm">Create Weekly Schedule </a></strong></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td width="50%" align="center" valign="top" class="style2 style4"><span class="burgundy"><a href="cancel.cfm" target="_blank"><strong>Cancel Migration </strong></a></span></td>
                    <td width="50%" align="center" valign="top" class="burgundy">&nbsp;</td>
                  </tr>
                </table>
