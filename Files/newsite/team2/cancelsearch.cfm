...
Select *
From master
Where actualdate=#parsedatetime(cdate)#
</cfquery>
...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=675,height=600');");
}
// End -->
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
				...
				<br>
	<table width="100%"  border="0" cellpadding="2" cellspacing="2" bordercolor="#CCCCCC" bgcolor="#CCCCCC">
	<tr bgcolor="#eeeeee" class="burgundy">
        <th scope="col"></th>
		 <th scope="col"><strong>Name</strong></th>
         <th scope="col"><strong>Function</strong></th>
         <th scope="col"><strong>Migration Date</strong></th>
         <th scope="col"><strong>Time</strong></th>
        <th scope="col"><strong>Floor</strong></th>
         <th scope="col"><strong>Machine Type</strong></th>
      </tr>
	<cfoutput query="lookup">
      <tr bgcolor="##FFFFFF">
        <td width="36"><a href="javascript:popUp('cancelmigration.cfm?recordID=#ID#')" class="style5">CANCEL</a></td>
