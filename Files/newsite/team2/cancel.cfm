...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                ...
                <p align="center" class="burgundy"><strong>Migration Cancelation</strong></p>
                <p>Select Day</p>
                <form name="form" method="post" action="cancelsearch.cfm">
  <p>
	<input type=text name='cdate' size=10 maxlength=10 value='...' >
</label>
<script language='javascript'>
if (!document.layers) {
document.write("<input type=button onclick='popUpCalendar(this, form.cdate, \"m/d/yyyy\")' value='select' style='font-size:11px'>")
}
</script>
</p>
  <p>
