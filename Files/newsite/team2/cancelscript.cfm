...
<cfquery name="updatequery" datasource="newdsi">
UPDATE master SET actualdate='7/5/2005' WHERE ID=#ID#
</cfquery>
<cfoutput>
  <div align="center"><span class="burgundy"><strong>Customer #Form.lname#, #Form.fname# has been Canceled<br>
  You may now
    </strong></span><br>
    <br>
...
<cfmail from="Migration Cancelation" to="nynacs.team@ny.frb.org,ny.dsi.migration.scheduler@ny.frb.org,Alex.Breytman@ny.frb.org,Alexey.Mirsky@ny.frb.org,Cecil.Alleyne@ny.frb.org,Dev.Kewalramani@ny.frb.org,Paul.Florenz@ny.frb.org,Glen.Radziminski@ny.frb.org,Hok.Koo@ny.frb.org,Jeff.Segal@ny.frb.org,John.DaSilva@ny.frb.org,Jonathan.Shafer@ny.frb.org,Larry.Koenig@ny.frb.org,Lawrence.Thal@ny.frb.org,Luis.Henriquez@ny.frb.org,Mel.Vail@ny.frb.org,Michael.Tudor@ny.frb.org,Stephen.Hawkins@ny.frb.org,Vincent.Gulizio@ny.frb.org,Yi-Ting.Tseng@ny.frb.org" subject="User #Form.lname#,#form.fname# has been Canceled">

Today's Date: #form.todate#
Scheduled Date: #form.sdate#
The following User has been Canceled
...
<!--Alex.Breytman@ny.frb.org,Alexey.Mirsky@ny.frb.org,Cecil.Alleyne@ny.frb.org,Dev.Kewalramani@ny.frb.org,Eric.Okimoto@ny.frb.org,Glen.Radziminski@ny.frb.org,Hok.Koo@ny.frb.org,Jeff.Segal@ny.frb.org,Joe.Ling@ny.frb.org,John.DaSilva@ny.frb.org,Jonathan.Shafer@ny.frb.org,Larry.Koenig@ny.frb.org,Lawrence.Thal@ny.frb.org,Luis.Henriquez@ny.frb.org,Mel.Vail@ny.frb.org,Michael.Tudor@ny.frb.org,Nick.Avvento@ny.frb.org,Parker.Samuel@ny.frb.org,Stephen.Hawkins@ny.frb.org,Vincent.Gulizio@ny.frb.org,Yi-Ting.Tseng@ny.frb.org,Jodi.Edwards@ny.frb.org,PJ.PascallJames@ny.frb.org,Navin.Persaud@ny.frb.org,Nick.Berardinelli@ny.frb.org-->
