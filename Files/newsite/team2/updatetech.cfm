...
UPDATE master SET tech='#form.tech#', floater='#form.floater#', stime='#form.stime#' WHERE ID=#form.ID#
</cfquery>
	 ...
	 <input name="save" type="submit" value=" Save ">
	  ...
	  <td>
	    ...
	    <select name="tech">
		 ...
		 <option value=""></option>
        <cfloop query="techlookup">
         <option value="#techlookup.lname#">#techlookup.lname#,#techlookup.fname#</option>
         </cfloop>
	      </select>
	    </span>	  </td>
      <td>
