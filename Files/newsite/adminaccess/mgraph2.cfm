...
<cfelseif #form.range# eq 'now'	>
	<cfset bdate=dateformat('1/1/04','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
<cfelseif #form.range# eq 'currentm'>
	<cfif dateformat(now(),'mmm') eq 'jan'>
	<cfset bdate=dateformat('1/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'feb'>
	<cfset bdate=dateformat('2/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'mar'>
	<cfset bdate=dateformat('3/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'apr'>
	<cfset bdate=dateformat('4/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'may'>
	<cfset bdate=dateformat('5/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'jun'>
	<cfset bdate=dateformat('6/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'jul'>
	<cfset bdate=dateformat('7/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'aug'>
	<cfset bdate=dateformat('8/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'sep'>
	<cfset bdate=dateformat('9/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'oct'>
	<cfset bdate=dateformat('10/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'nov'>
	<cfset bdate=dateformat('11/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	<cfelseif dateformat(now(),'mmm') eq 'dec'>
	<cfset bdate=dateformat('12/1/2004','m/d/yyyy')>
	<cfset edate=dateformat(now(),'m/d/yyyy')>
	</cfif>	
</cfif>
