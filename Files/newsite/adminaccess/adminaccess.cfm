...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
				...
				<cfif #url.error# eq 0>
<cfform name="form" method="post" action="adminpage.cfm">
       
	   <p>&nbsp;	     </p>
	   <p align="center">
	     <input type="text" name="auth" value="Admin" readonly="yes">
	     </p>
	   <p align="center">Enter your Password<br>
    <cfinput type="password" name="pass" required="yes" message="Please enter the Admin Password" >
    </p>
       <div align="center"><bt>
...
<div align="center">
  <cfelseif #url.error# eq 1>
  
  <span class="style2 style1"><strong>You Entered The Wrong Password Please Try Again!
    </strong></span>
    
</div>
<form name="form" method="post" action="adminpage.cfm">
           
	   <p align="center">
	         <span class="style2 style1">
	         <input type="text" name="auth"  class="burgundy"value="Admin" readonly="yes" style="background-color:#eeeeee ">
	         </span></p>
	       <p align="center"><span class="style2 style1">Enter your Password<br>
               <input type="password" name="pass" style="background-color:#eeeeee ">
           </span></p>
           <div align="center"><span class="style2 style1"><bt>
	               <input name="submit" type="submit" id="submit" value="Login">
           </span></div>
           <span class="style2 style1">         </span><span class="style2 style1"></span>
  </form>
<span class="style2 style1"></span>
				  </cfif>
