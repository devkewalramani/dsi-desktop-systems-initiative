...
<table width="100%"  border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#000000">
  <tr bgcolor="#CCCCCC">
    <th colspan="2" scope="col"><span class="burgundy"><strong>Current Reports</strong></span></th>
    </tr>
  <tr align="center" valign="bottom" bgcolor="#FFFFFF" class="burgundy">
    <td width="50%"><a href="NY_DSI_Issues.pdf"><strong>NY DSI Issues</strong></a></td>
    <td width="50%"><strong>Report 2</strong></td>
  </tr>
</table>
