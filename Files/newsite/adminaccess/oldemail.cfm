...
<cfquery name="emailbal" datasource="newdsi">
Select *
from emailbal
</cfquery>
<table width="100%"  border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
  <tr bgcolor="#eeeeee" class="burgundy">
    <th scope="col"><span class="style1">Function</span></th>
    <th scope="col"><span class="style1">1.First Name </span></th>
    <th scope="col"><span class="style1">1.Last Name </span></th>
    <th scope="col"><span class="style1">2.First Name</span></th>
    <th scope="col"><span class="style1">2.Last Name</span></th>
    <th scope="col"><span class="style1">3.First Name</span></th>
    <th scope="col"><span class="style1">3.Last Name</span></th>
    <th scope="col"><span class="style1">4.First Name</span></th>
    <th scope="col"><span class="style1">4.Last Name</span></th>
    <th scope="col"><span class="style1">5.First Name</span></th>
    <th scope="col"><span class="style1">5.Last Name</span></th>
  </tr>
  <cfoutput query="emailbal">
  <tr bgcolor="##FFFFFF">
    <td>#func#</td>
    <td>#Bal1first#</td>
    <td>#Bal1last#</td>
