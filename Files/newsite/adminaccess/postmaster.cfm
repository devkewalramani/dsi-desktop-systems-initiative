...
<cfquery name="postmaster" datasource="newdsi">
INSERT INTO master (grp,func,lname,fname,loc,flr,ph,mtype1,dispo1,stat1,odate,sdate,adate,mitime,comment) VALUES('#FORM.Make#','#FORM.Team#','#FORM.lname#','#FORM.fname#','#FORM.loc#','#FORM.flr#','#FORM.ph#','#FORM.mtype1#','#FORM.dispo1#','#FORM.stat1#','#FORM.odate#','#FORM.sdate#','#FORM.adate#','#FORM.mitime# #FORM.t1#','#FORM.comment#')
</cfquery>

<meta http-equiv="refresh" content="1;URL=./scheduling.cfm">
<cfoutput>
<p>Customer #Form.fname# #Form.lname# was Scheduled! <br>
