...
<cfquery name="updatect" datasource="newdsi">
update grouptotal set tot='#form.tot#' where id=#form.id#
</cfquery>

<cfoutput>
<div align="center"><span class="burgundy"><strong>
#form.grp# has been updated!

</strong></span><br></cfoutput>
  
</div>
<meta http-equiv="refresh" content="1;URL=grpdevicecount.cfm">
