...
SELECT DISTINCT teamtwo.tech, Avg(teamtwo.preextract) AS [preextract], Avg(teamtwo.extraction) AS [extraction], Avg(teamtwo.swaphw) AS [swaphw], Avg(teamtwo.firstboot) AS [firstboot], Avg(teamtwo.injection) AS [injection], Avg(teamtwo.smsclient) AS [smsclient], Avg(teamtwo.userlogin) AS [userlogin], Avg(teamtwo.postmi) AS [postmi], Avg(teamtwo.userverifi) AS [userverifi],Avg(teamtwo.other) AS [other]
FROM teamtwo
