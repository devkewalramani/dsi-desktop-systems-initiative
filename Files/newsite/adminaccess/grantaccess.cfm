...
<div align="center"><span class="burgundy"><strong><br>
  1=Allow   0=Not Allowed
  </strong></span><br>
  
</div>
<table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#CCCCCC">
<tr bgcolor="#eeeeee" class="burgundy">
<th scope="col"><strong>Function Name</strong></th>
<th scope="col"><strong>BAL Page</strong></th>
<th scope="col"></th>
<th scope="col"><strong>Attachment F</strong></th>
<th scope="col"></th>
</tr>
<cfoutput query="grant">
<tr bgcolor="##FFFFFF">
<td>#func#</td>
<form method="post" action="balgrantscript.cfm">
<input type="hidden" name="id" value="#id#">
<td><input type="text" name="bgrant" value="#bgrant#"></td>
<td><input type="submit" value="Submit"></td>
</form>
<form method="post" action="attachfgrantscript.cfm">
<input type="hidden" name="id" value="#id#">
<td><input type="text" name="attachfgrant" value="#attachfgrant#"></td>
<td><input type="submit" value="Submit"></td>
</form>
</tr>
</cfoutput>
