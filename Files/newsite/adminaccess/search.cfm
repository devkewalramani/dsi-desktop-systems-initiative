...
<title>BAL Access Search Page</title>
<!-- InstanceEndEditable -->
...
<form name="form" method="post" action="editschedule.cfm">
  <p>
    <input name="lname" type="text" size="50" maxlength="50" tabindex="0">
</p>
  <p>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th bgcolor="#CCCCCC" scope="col"><strong class="burgundy"><a href="./migration/request.cfm" target="_self">View Reschedule Request Pipline</a> </strong></th>
  </tr>
</table>
