...
<cfmail from="DSI Orientation Rescheduler" to="Nancy.Bailey@ny.frb.org,Pamela.Andrews@ny.frb.org,Patricia.Gordon@ny.frb.org,Louis.Bryan@ny.frb.org"  subject="User #Form.name# has been Rescheduled">
...
Customer #form.name# has been Rescheduled for Orientation 
<br><br>You may now
<br><br>
