...
<form action="balupdate.cfm" method="post" target="_blank">
...
<table width="700" border="0">
  ...
  <tr>
  <td><input type="text" name="func" value="#func#" size="15" maxlength="30"></td>
...
<table width="100%"  border="0" cellpadding="1" cellspacing="1" bgcolor="##cccccc">
  ...
  <tr bgcolor="##FFFFFF">
    <td>
      <div align="center">
        <input type="button" value="Schedule Orientation" onClick="javascript:popUp('./orientation/index.cfm?id=#id#&reschedule=0')">
      </div>
    </td>
    <td>
      <div align="center">
        <input type="button" value="Schedule XP Training" onClick="javascript:popUp('./training/index.cfm?id=#id#&reschedule=0')">
      </div>
    </td>
    <td>
      <div align="center">
        <input type="button" value="Schedule Migration" onClick="javascript:popUp('./migration/index.cfm?id=#id#&reschedule=0')">
      </div>
    </td>
  </tr>
</table>
