...
UPDATE master SET func='#func#',logon='#form.logon#',context='#form.context#',loc='#form.loc#', flr='#form.flr#', office='#form.office#',ph='#form.ph#', wrkhrs='#form.wrkhrs#', blkberry='#form.blkberry#', mtype='#form.mtype#', dispo='#form.dispo#', itemdesc='#form.desc#', serial='#form.serial#', replacemodel='#form.model#', status='#form.status#',comment='#form.comment#' Where ID=#form.ID#
</cfquery>
<cfoutput>
  <div align="center"><span class="burgundy"><strong>#form.name# has been updated
    <br>
    <br>
  You may now
    </strong></span><br>
