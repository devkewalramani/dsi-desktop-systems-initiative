...
<cfquery name="setlimit" datasource="newdsi">
UPDATE functionlimit SET limit=#form.limit#, weekrestriction='#form.wrestrict#' WHERE ID=#form.id#
</cfquery>

<div align="center" class="style1">
  <p class="style2">Function Limit and/or Restriction Updated<br>
    Refreshing Page....
    <br>
  </p>
  </div>
<meta http-equiv="refresh" content="1;URL=functionlimit.cfm">
