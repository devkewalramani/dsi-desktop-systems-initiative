...
SELECT [teamoneold].[tech], Avg([teamoneold].[hdd]) AS [hdd], Avg([teamoneold].[sysprep]) AS[sysprep], Avg([teamoneold].[gw]) AS [gw], Avg([teamoneold].[joinrb]) AS [joinrb], Avg([teamoneold].[policy]) AS [policy], Avg([teamoneold].[dns]) AS [dns], Avg([teamoneold].[mapk]) AS [mapk], Avg([teamoneold].[otherapps]) AS [otherapps], Avg([teamoneold].[context]) AS [context], Avg([teamoneold].[rr]) AS [rr]
FROM teamoneold
