...
<cfquery name="deletecust" datasource="newdsi">
DELETE FROM master WHERE ID=#form.ID#
</cfquery>

<cfmail from="DSI Admin" to="#form.balfname#.#form.ballname#@ny.frb.org" subject="User #FORM.lname#, #FORM.fname# Deleted">
Your request to have
#FORM.fname# #FORM.lname# deleted
is complete
...
DSI Staff
  ...
  <div align="center" class="burgundy"><strong>Customer #FORM.lname#, #FORM.fname# deleted
        <br>
  Refreshing Page
  </strong></div>
</cfoutput>
<meta http-equiv="refresh" content="2;URL=deletesearch.cfm">
<div align="center"><br>
</div>
