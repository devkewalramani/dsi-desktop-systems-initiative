...
<center>
<span class="burgundy"><strong>Updating Time Slots

<cfquery name="updatetime" datasource="newdsi">
update timeslots set ts1='#form.ts1#',ts2='#form.ts2#',ts3='#form.ts3#',ts4='#form.ts4#',ts5='#form.ts5#',ts6='#form.ts6#',ts7='#form.ts7#',ts8='#form.ts8#',ts9='#form.ts9#',ts10='#form.ts10#',ts11='#form.ts11#',ts12='#form.ts12#',ts13='#form.ts13#',ts14='#form.ts14#',ts15='#form.ts15#',ts16='#form.ts16#',ts17='#form.ts17#',ts18='#form.ts18#',ts19='#form.ts19#',ts20='#form.ts20#' where func='#form.func#'
</cfquery>
<br>
<br>
You may now
