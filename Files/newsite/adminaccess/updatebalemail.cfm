...
<title>Updating Email Addresses</title>
<!-- InstanceEndEditable -->
...
<cfquery name="updateemail" datasource="newdsi">
update emailbal set Bal1first='#Bal1first#',Bal1last='#Bal1last#',Bal2first='#Bal2first#',Bal2last='#Bal2last#',Bal3first='#Bal3first#',Bal3last='#Bal3last#',Bal4first='#Bal4first#',Bal4last='#Bal4last#',Bal5first='#Bal5first#',Bal5last='#Bal5last#' where id=#form.id#
</cfquery>

<div align="center"><span class="burgundy"><strong>Function BAL Email Addresses Updated!<br>
 </strong></span><br>
