...
<cfquery name="grpct" datasource="newdsi">
Select *
from grouptotal
order by grp ASC				
</cfquery>
...
<table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#cccccc">
  <tr align="left" bgcolor="#eeeeee" class="burgundy">
    ...
    <th scope="col"><div align="center">Total Device Count</div></th>
	<th scope="col"><div align="center"></div></th>
  </tr>
<cfoutput query="grpct">
<form method="post" action="updategrpdevicect.cfm">
  <tr bgcolor=##ffffff>
  <input type="hidden" name="id" value="#id#">
    <td width="33%"><input type="text" name="grp" value="#grp#" readonly="yes"></td>
    <td width="33%"><input type="text" name="tot" value="#tot#"></td>
