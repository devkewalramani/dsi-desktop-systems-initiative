...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="5">
  <tr>
    <td align="center" valign="top"><form name="form" method="post" action="mgraph2.cfm">
  <p>  
  <span class="burgundy">Select by Defined Ranges</span><br>
    <select name="range">
      <option value="current">Current Week</option>
      <option value="last">Last Week</option>
      <option value="now">To Date</option>
      <option value="currentm">Current Month</option>
    </select>
    <br>  
  <p>
    <input name="submit" type="submit" value="Submit">    
	</form></td>
    <td align="center" valign="middle" bgcolor="#CCCCCC"><p class="burgundy"><strong>OR</strong></p>
      </td>
    <td align="center" valign="top"><form name="range" method="post" action="mgraph4.cfm"><p>  <span class="burgundy">Please enter your start date:</span>  <br>
  ...
  <br>
  <span class="burgundy">Please enter you end date:</span>  <br>    
