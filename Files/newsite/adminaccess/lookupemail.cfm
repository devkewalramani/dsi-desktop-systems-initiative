...
<br><cfoutput>
  <div align="center" class="burgundy"><strong>#Form.Team# Function</strong></div>
</cfoutput>
<div align="center"><br>				
				  
</div>
<cfoutput>
<cfif #lookup.func# neq "">
<form method="post" action="updatebalemail.cfm">
<div style="border:1px black solid; width:700px; height:75px; overflow-y:auto; overflow-x:auto;">
<table width="700"  border="0" cellpadding="1" cellspacing="1" bgcolor="##CCCCCC">
  <tr bgcolor="##eeeeee" class="burgundy">
    <th colspan="2" scope="col"><span class="style1">1.First &amp; </span><span class="style1">Last Name</span></th>
    <th colspan="2" scope="col"><span class="style1">2.</span><span class="style1">First &amp; </span><span class="style1">Last Name</span></th>
    <th colspan="2" scope="col"><span class="style1">3.</span><span class="style1">First &amp; </span><span class="style1">Last Name</span></th>
    <th colspan="2" scope="col"><span class="style1">4.</span><span class="style1">First &amp; </span><span class="style1">Last Name</span></th>
    <th colspan="2" scope="col"><span class="style1">5.</span><span class="style1">First &amp; </span><span class="style1">Last Name</span></th>
    </tr>	
  <cfloop query="lookup">
  <input type="hidden" name="id" value="#id#">
  <tr bgcolor="##FFFFFF" >
    <td width="15"><input type="text" value="#Bal1first#" name="Bal1first" size="10" ></td>
    <td width="15"><input type="text" value="#Bal1last#" name="Bal1last" size="10"></td>
    <td width="15"><input type="text" value="#Bal2first#" name="Bal2first" size="10"></td>
    <td width="15"><input type="text" value="#Bal2last#" name="Bal2last" size="10"></td>
    <td width="15"><input type="text" value="#Bal3first#" name="Bal3first" size="10"></td>
    <td width="15"><input type="text" value="#Bal3last#" name="Bal3last" size="10"></td>
    <td width="15"><input type="text" value="#Bal4first#" name="Bal4first" size="10"></td>
    <td width="15"><input type="text" value="#Bal4last#" name="Bal4last" size="10"></td>
    <td width="15"><input type="text" value="#Bal5first#" name="Bal5first" size="10"></td>
    <td width="15"><input type="text" value="#Bal5last#" name="Bal5last" size="10"></td>
  </tr>
  </cfloop>
</table>
</div>
<br>
<center><input type="submit" value="Update" align="middle"></center>
</form>
<cfelse>
<div align="center" class="burgundy"><strong>Function Not Defined In BAL Email Table!
</strong></div>
</cfif>
</cfoutput>
