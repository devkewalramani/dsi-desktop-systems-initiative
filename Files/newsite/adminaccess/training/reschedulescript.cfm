...
<cfmail from="DSI XP Training Rescheduler" to="Nancy.Bailey@ny.frb.org,Pamela.Andrews@ny.frb.org,Patricia.Gordon@ny.frb.org,Louis.Bryan@ny.frb.org"  subject="User #Form.name# has been Rescheduled">
The following User has been Rescheduled For XP Training Session
...
Customer #form.name# has been Rescheduled for XP Training 
<br><br>You may now
<br><br>
