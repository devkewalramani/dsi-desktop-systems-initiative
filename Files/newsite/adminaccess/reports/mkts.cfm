...
<cfquery name="mktmay" datasource="newdsi">
Select count(*) as mayct
from master
where func='Markets' and actualdate >= '5/1/2004' and actualdate <= '5/31/2004' and actualdate is not null
</cfquery>

<cfquery name="mktjune" datasource="newdsi">
Select count(*) as junect
from master
where func='Markets' and actualdate >=  '6/1/2004' and actualdate <= '6/30/2004' and actualdate is not null
</cfquery>

<cfquery name="mktjuly" datasource="newdsi">
Select count(*) as julyct
from master
where func='Markets' and actualdate >= '7/1/2004' and actualdate <= '7/31/2004' and actualdate is not null
</cfquery>

<cfquery name="mktaug" datasource="newdsi">
Select count(*) as augct
from master
where func='Markets' and actualdate >= '8/1/2004' and actualdate <= '8/30/2004' and actualdate is not null
</cfquery>
<cfoutput>
<table width="100%"  border="0" cellpadding="1" cellspacing="1" bgcolor="##cccccc">
  <tr bgcolor="##eeeeee" class="burgundy">
    ...
    <th scope="col"><strong>July</strong></th>
    <th scope="col"><strong>August</strong></th>
  </tr>
  <tr bgcolor="##FFFFFF">
    <td><div align="center">#mktmay.mayct#</div></td>
    <td><div align="center">#mktjune.junect#</div></td>
    <td><div align="center">#mktjuly.julyct#</div></td>
    <td><div align="center">#mktaug.augct#</div></td>
  </tr>
</table>
</cfoutput>
