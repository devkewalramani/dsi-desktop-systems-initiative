...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                ...
                <table width="100%"  border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#cccccc">
                  <tr align="center" valign="middle" bgcolor="#eeeeee" class="burgundy">
                    <th colspan="3" scope="col"><strong>REPORTS</strong></th>
                    </tr>
                  <tr align="center" valign="middle" bgcolor="#FFFFFF" class="burgundy">
                    <td width="50%"><a href="./nyissue/" target="_blank"><strong>NY DSI Issue Log </strong></a></td>
                    <td width="50%"><a href="../issue/issuegen.cfm"><strong>Migration Issue Log Report</strong></a></td>
                    </tr>
                </table>
				<br>
                <table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#cccccc">
                  <tr align="center" valign="middle" bgcolor="#eeeeee">
                    <th colspan="2" class="burgundy" scope="col"><div align="center"><strong>GRAPHS</strong></div></th>
                    </tr>
                  <tr align="center" valign="middle" bgcolor="#FFFFFF">
                    <td width="50%"><div align="center"><strong><a href="mgraph.cfm">Migration Analysis</a></strong></div></td>
                    <td width="50%"><div align="center"><strong><a href="maingraph.cfm">DSI Customer Device Migrations</a> </strong></div></td>
                  </tr>
                </table>
				<br>
                <table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#cccccc">
                  <tr align="center" valign="middle" bgcolor="#eeeeee" class="burgundy">
                    <th colspan="3" scope="col"><strong>CURRENT MIGRATION STATUS PIE CHARTS </strong></th>
                    </tr>
                  <tr align="center" valign="middle" bgcolor="#FFFFFF" class="burgundy">
                    <td width="33%"><a href="pie1.cfm"><strong>Bank Wide Devices</strong></a></td>
                    <td width="33%"><a href="groupstatus.cfm"><strong>Devices Migrated by Group</strong></a></td>
                    <td width="33%"><a href="functionstatus.cfm"><strong>Devices Migrated by Function</strong></a></td>
                  </tr>
                </table>
                <p>&nbsp;</p>
