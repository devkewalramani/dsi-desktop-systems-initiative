...
<cfquery name="getcustinfo" datasource="newdsi">
Select *
from master
where ID=#url.recordID#
</cfquery>

<cfoutput query="getcustinfo">
<div align="center" class="burgundy"><strong>ADMIN DELETE CUSTOMER PAGE </strong><strong></strong></div>
<cfform name="form" method="post" action="deletecustscript.cfm">
<input type="hidden" name="ID" value="#url.recordID#">
<span class="burgundy">First Name</span>
<cfinput name="fname" type="text" value="#fname#" required="yes" message="Please enter the user's first name">
<br>
<span class="burgundy">Last Name</span>
<cfinput name="lname" type="text" value="#lname#" required="yes" message="Please enter the user's last name">
<div align="center">
  <p class="burgundy"><strong> Please specify Asset Type and Serial Number</strong></p>
  <p align="left"><span class="burgundy">Asset Type</span>
...
<option value="Laptop">Laptop</option>
    ...
    <cfinput name="serial" type="text" value="#serial#" required="yes" message="Please enter the assets serial number">
<br>
  ...
  <div align="center">
    <p>
      <input name="submit" type="submit" id="submit" value="Delete User">
</p>
    </div>
</cfform>
</cfoutput>
