...
<title>Set Daily Function Limits</title>
<!-- InstanceEndEditable -->
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr bgcolor="#CCCCCC" class="burgundy">
    <th scope="col"><div align="left">Function</div></th>
    <th scope="col"><div align="left">Limit</div></th>
    <th scope="col"><div align="left">Week Restriction</div></th>
	<th scope="col"></th>
  </tr>
  <cfoutput query="funclimit">
  <form name="form" method="post" action="setlimit.cfm">
  <input type="hidden" name="ID" value="#ID#">
  <tr bgcolor=###IIF(funclimit.currentrow MOD 2,DE ('FFFFFF'),DE ('dddddd'))#>
    <td>#func#&nbsp;</td>
    <td><input name="limit" type="text" size="6" maxlength="6" value="#limit#"></td>
    <td><input name="wrestrict" type="text" size="6" maxlength="6" value="#weekrestriction#"></td>
