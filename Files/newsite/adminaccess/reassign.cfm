...
UPDATE master SET lname='#form.newlname#', fname='#form.newfname#', logon='#form.logon#', context='#form.context#' WHERE ID=#ID#
</cfquery>

<center>
<cfoutput>
  <span class="burgundy"><strong>Device has been reassigned to #Form.newlname#, #Form.newfname# <br>
...
<br>
<a href=""><img src="images/close.jpg" width="153" height="26" border="0"  class="burgundy" onClick="window.close()"></a>
</center>

<cfmail from="DSI Asset Re-assignment" to="#form.balfname#.#form.ballname#@ny.frb.org" subject="DSI Administrator">

Device Type: #form.mtype#
Serial number: #form.serial# 
Has been re-assigned to #form.newfname# #form.newlname#
