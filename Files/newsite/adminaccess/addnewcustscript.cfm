...
<cfif #FORM.make# neq "" and #FORM.team# neq "" and #FORM.lname# neq "" and #FORM.fname# neq "">				
<cfquery name="addnewcust" datasource="newdsi">
INSERT INTO master (grp,func,lname,fname) VALUES ('#FORM.make#','#FORM.team#','#FORM.lname#','#FORM.fname#')
</cfquery>
<cfoutput>
<cfmail from="DSI Admin" to="#form.balfname#.#form.ballname#@ny.frb.org" subject="User #FORM.lname#, #FORM.fname# Added">
Your request to have
#FORM.fname# #FORM.lname# added
is complete
...
DSI Staff
  ...
  <div align="center" class="burgundy"><strong>Customer #FORM.lname#, #FORM.fname# added
        <br>
  Refreshing Page
  </strong></div>
</cfoutput>
<meta http-equiv="refresh" content="2;URL=addnewcust.cfm">
<div align="center"><br>
</div>
<cfelse> 
<p align="center" class="burgundy"><strong>ALL FIELDS ARE REQUIRED</strong></p>
<p align="center"><span class="burgundy"><strong>PLEASE TRY AGAIN </strong></span> </p>
<meta http-equiv="refresh" content="2;URL=addnewcust.cfm">
</cfif>
