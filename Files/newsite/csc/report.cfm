...
SELECT Distinct lname,fname,max(actualdate) as actual,max(logon) as logon                         
FROM master
WHERE actualdate >= #parsedatetime(form.bdate)# AND actualdate <= #parsedatetime(form.edate)# 
...
<cfoutput><p align="center"><span class="burgundy"><strong>FRB NY DSI Project<br>
    Customers Migrated <br>
  From #form.bdate# to #form.edate#</strong></span></p>
  <hr align="left" width="100%" size="3" noshade color="##660033">
</cfoutput>
<table width="300"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999" bgcolor="#999999">
<tr align="left" valign="bottom" bgcolor="#CCCCCC" class="burgundy">
    <th scope="col"><span class="style2">Last Name </span></th>
    <th scope="col"><span class="style2">First Name</span></th>
	<th scope="col"><span class="style2">B1 ID</span></th>
	<th scope="col"><span class="style2">Migration Date</span></th>
  </tr>
<cfoutput query="migrations">
  ...
  <td  scope="col"><span class="style3">#dateformat(actual,'m/d/yyyy')#</span></td>
  </tr>
<cfset ctr=ctr+1>  
</cfoutput>
</table>
...
<cfoutput>
  <div align="center" class="burgundy"> 
    <p><strong>Total: #ctr#</strong></p>
    </div>
</cfoutput>
