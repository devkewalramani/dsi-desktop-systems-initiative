...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
				...
				<cfif #url.error# eq 0>
<form name="form" method="post" action="cscpage.cfm">
       
	   <p>&nbsp;	     </p>
	   <p align="center">
	     <input type="text" name="auth" value="CSCAdmin" readonly="yes">
	     </p>
...
<form name="form" method="post" action="cscpage.cfm">
	   ...
	   <p align="center">
	         ...
	         <input type="text" name="auth"  class="burgundy"value="CSCAdmin" readonly="yes" style="background-color:#eeeeee ">
	         </span></p>
