...
<title>DSI Migration Website - CSC</title>
<!-- InstanceEndEditable -->
...
<table width="100%" cellpadding="2" cellspacing="2" bgcolor="##ccccccc">
    ...
    <tr bgcolor="##FFFFFF">
      <td width="50%"><div align="center">Device Migrations </div></td>
      <td width="50%"><div align="center"><a href="schedule.cfm" class="burgundy"><strong>Customer Migrations</strong></a> </div></td>
    </tr>
  </table>
  <p>&nbsp;</p>
  <table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="##cccccc">
    ...
    <tr bgcolor="##FFFFFF" class="burgundy">
