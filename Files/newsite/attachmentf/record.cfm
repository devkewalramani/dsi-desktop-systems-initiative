...
<cfset edate=dateformat('2/1/2005','m/d/yyyy')>

<cfset #bdate#=#dateformat(bdate,'m/d/yyyy')#>
<cfset #edate#=#dateformat(edate,'m/d/yyyy')#>

<cfquery name="grant" datasource="newdsi">
Select attachfgrant
from functionpass
...
<cfoutput>
<cfif #grant.attachfgrant# eq '0'>
  <div align="center"><span class="burgundy"><strong>Your Function is using the "E-Mail" version of Attachment F.<br>Please contact your BAL for further instructions.<br></strong></span>
  </div>
  <cfelse>
<cfquery name="lookup" datasource="newdsi">
Select *
From master
Where func='#form.team#' AND lname='#form.lname#' 
</cfquery>

<cfif #lookup.id# neq "" >
<table width="100%" cellpadding="1" cellspacing="2" bgcolor="##cccccc">
  ...
  <cfloop query="lookup">
<cfif #lookup.attachstatus# neq 'pending' and #lookup.attachstatus# neq 'approved' and #lookup.attachstatus# neq 'revisionapproved' and #lookup.attachstatus# neq 'revised' and #lookup.attachstatus# neq 'pendingrevised' and #lookup.attachstatus# neq 'balrevision'>
  <tr bgcolor="##FFFFFF">
    <td><a href="attachment.cfm?recordID=#ID#" class="style5">Click Here to Access Attachment F</a>&nbsp;</td>
    <td><span class="style5">#lname#,#fname#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#flr#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#mtype#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#status#&nbsp;</span>&nbsp;</td>
    <td>#serial#</td>
  </tr>
<cfelseif #lookup.attachstatus# eq 'pending'>
<tr bgcolor="##FFFFFF">
    <td bgcolor="##FFFFFF" class="burgundy">Pending BAL Approval&nbsp;</td>
    <td><span class="style5">#lname#,#fname#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#flr#&nbsp;</span>&nbsp;</td>
...
<cfelseif #lookup.attachstatus# eq 'pendingrevised'>
<tr bgcolor="##FFFFFF">
    <td bgcolor="##FFFFFF" class="burgundy">Revision Pending BAL Approval&nbsp;</td>
    <td><span class="style5">#lname#,#fname#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#flr#&nbsp;</span>&nbsp;</td>
...
<cfelseif #lookup.attachstatus# eq 'approved'> 
<tr bgcolor="##FFFFFF">
    <td bgcolor="##FFFFFF" class="burgundy">Approved&nbsp;</td>
    <td><span class="style5">#lname#,#fname#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#flr#&nbsp;</span>&nbsp;</td>
...
<cfelseif #lookup.attachstatus# eq 'revisionapproved'> 
<tr bgcolor="##FFFFFF">
    <td bgcolor="##FFFFFF" class="burgundy"><a href="attachment2.cfm?recordID=#ID#" class="style5">Pending Revision</a>&nbsp;</td>
    <td><span class="style5">#lname#,#fname#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#flr#&nbsp;</span>&nbsp;</td>
...
<cfelseif #lookup.attachstatus# eq 'revised'> 
<tr bgcolor="##FFFFFF">
    <td bgcolor="##FFFFFF" class="burgundy">Revision Approved&nbsp;</td>
    <td><span class="style5">#lname#,#fname#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#flr#&nbsp;</span>&nbsp;</td>
  ...
  <cfelseif #lookup.attachstatus# eq 'balrevision'> 
   <tr bgcolor="##FFFFFF">
    <td bgcolor="##FFFFFF" class="burgundy">BAL to revise&nbsp;</td>
    <td><span class="style5">#lname#,#fname#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#flr#&nbsp;</span>&nbsp;</td>
...
<cfelseif #lookup.id# eq "">
<div align="center" class="burgundy"><strong>No Records Found Please Contact your BAL
</strong></div>
</cfif>
</cfif>
</cfoutput>
