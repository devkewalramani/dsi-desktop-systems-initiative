...
Select *
From master
Where attachstatus <> 'pending' and attachstatus <> 'pendingrevised' and attachstatus <> 'reviseunlock'
order by actualdate asc
</cfquery>
...
<table width="100%" cellpadding="2" cellspacing="2" bgcolor="##cccccc">
  ...
  <cfloop query="lookup">
  <cfif #attachstatus# eq 'approved'>
  <tr bgcolor="##FFFFFF">
    <td><a href="attachment.cfm?recordID=#ID#" class="style5">Approved</a>&nbsp;</td>
    <td bgcolor="##eeeeee" class="burgundy"><strong><span class="style5">#lname#, #fname#&nbsp;</span>&nbsp;</strong></td>
    <td><span class="style5">#func#&nbsp;</span>&nbsp;</td>
    <td bgcolor="##eeeeee" class="burgundy"><div align="center"><strong><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</strong></div></td>
  ...
  <cfelseif #attachstatus# eq 'revised'>
  <tr bgcolor="##FFFFFF">
    <td><a href="attachment.cfm?recordID=#ID#" class="style5">Revised</a>&nbsp;</td>
    <td bgcolor="##eeeeee" class="burgundy"><strong><span class="style5">#lname#, #fname#&nbsp;</span>&nbsp;</strong></td>
    <td><span class="style5">#func#&nbsp;</span>&nbsp;</td>
    <td bgcolor="##eeeeee" class="burgundy"><div align="center"><strong><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</strong></div></td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
