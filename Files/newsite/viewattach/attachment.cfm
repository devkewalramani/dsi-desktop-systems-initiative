...
<style type="text/css">
<!--
.style2 {font-family: Verdana, Arial, Helvetica, sans-serif; color: 560808;}
-->
</style>
<!-- InstanceEndEditable -->
...
<cfoutput>
<cfif #lookup.attachstatus# eq 'approved'>
<div align="center"><span class="style2"><strong>APPROVED #dateformat(lookup.attachdate,'m/d/yyyy')#</strong></span></div>
<cfelseif #lookup.attachstatus# eq 'revised'>
<div align="center"><span class="style2"><strong>REVISED #dateformat(lookup.attachdate,'m/d/yyyy')#</strong></span></div>
</cfif>
