...
<cfquery name="updateb1" datasource="newdsi">
UPDATE master SET logon='#form.logon#', context='#form.context#' where id=#form.id#
</cfquery>

<div align="center" class="burgundy">
  <p><strong>Update Saved</strong></p>
  <p><strong>Refreshing page </strong></p>
</div>
<meta http-equiv="refresh" content="0;URL=search.cfm">
