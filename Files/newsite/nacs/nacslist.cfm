...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                ...
                <cfquery name="nacslist" datasource="newdsi">
				Select *
				From nacslist
				Order by lname ASC
				</cfquery>
				...
				<p align="center" class="burgundy"><strong>NACS Employee List</strong></p>
                <table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#CCCCCC">
				  ...
				  <cfoutput query="nacslist">
                  <tr bgcolor="##FFFFFF">
                    <td>#lname#&nbsp;</td>
                    <td>#fname#&nbsp;</td>
                    <td>#nextel#&nbsp;</td>
                    <td>#email#&nbsp;</td>
                    <td><strong><a href="update.cfm?recordID=#ID#">UPDATE</a></strong></td>
                    <td><div align="left"><strong><a href="delete.cfm?recordID=#ID#">DELETE</a></strong></div></td>
                  </tr>
				  </cfoutput>
                </table>
				<br><br>
                <table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#000000">
                  <tr bgcolor="#CCCCCC" class="burgundy">
                    <td bgcolor="#eeeeee"><div align="center"><strong><a href="addnew.cfm">ADD NEW EMPLOYEE</a> </strong></div></td>
                    </tr>
                </table>
