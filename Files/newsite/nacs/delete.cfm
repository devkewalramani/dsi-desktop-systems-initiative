...
<cfquery name="emp" datasource="newdsi">
Select *
from nacslist
where id=#url.recordID#
</cfquery>

<p align="center" class="burgundy"><strong>NACS Delete Employee</strong></p>
...
<cfoutput query="emp">
<form name="form" method="post" action="deletescript.cfm">
<tr bgcolor="##FFFFFF">
...
<tr bgcolor="##CCCCCC">
  <td colspan="4" class="burgundy"><div align="center"><strong>ARE SURE YOU WANT TO DELETE THIS EMPLOYEE?</strong></div></td>
</tr>
<tr bgcolor="##FFFFFF">
