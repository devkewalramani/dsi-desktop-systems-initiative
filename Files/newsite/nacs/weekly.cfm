...
<cfquery name="nacstech" datasource="newdsi">
select *
from nacslist
Order by lname ASC
</cfquery>
<form name="form" method="post" action="weekscript.cfm">
  <span class="burgundy">Week of:</span>  <br>
...
<table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#FFFFFF">
    <td><select name="mon" id="mon">
	 <option value=""></option>
     <cfoutput query="nacstech">
     <option value="#lname#, #fname# x#nextel#">#lname#, #fname# x#nextel#</option>
     </cfoutput>
    </select>
    </td>
    <td><select name="tues" id="tues">
	 <option value=""></option>
     <cfoutput query="nacstech">
     <option value="#lname#, #fname# x#nextel#">#lname#, #fname# x#nextel#</option>
     </cfoutput>
