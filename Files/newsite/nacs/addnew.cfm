...
<p align="center" class="burgundy"><strong>NACS Add Employee</strong></p>
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
<tr align="center" valign="bottom" bgcolor="#CCCCCC" class="burgundy">
<th scope="col">Last Name </th>
<th scope="col">First Name </th>
<th scope="col">Nextel # </th>
<th scope="col">Email<br>
  <span class="style1">(first.last@ny.frb.org)</span></th>
</tr>
<cfform name="form" method="post" action="addscript.cfm">
<tr bgcolor="#FFFFFF">
<td><cfinput type="text" name="lname" tabindex="1" required="yes" message="A last name is required"></td>
<td><cfinput type="text" name="fname" tabindex="2" required="yes" message="A first name is required"></td>
<td><cfinput type="text" name="nextel"tabindex="3" required="yes" message="A nextel number is required"></td>
<td><cfinput type="text" name="email" tabindex="4" required="yes" message="An Internet Email address is required"></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td colspan="4"><div align="center">
    <input type="submit" name="Submit" value="Add New Employee" tabindex="5">
  </div></td>
  </tr>
</cfform>
</table>
