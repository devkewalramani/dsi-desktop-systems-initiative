...
<cfquery name="addnew" datasource="newdsi">
UPDATE nacslist SET lname='#form.lname#', fname='#form.fname#', nextel='#form.nextel#', email='#form.email#' Where ID=#form.id#
</cfquery>
<cfoutput>
  <p align="center" class="burgundy"><strong>Employee #form.lname#, #form.fname# has been updated
  </strong></p>
  <p align="center" class="burgundy"><strong>Refreshing Page...please wait </strong></p>
</cfoutput>
<meta http-equiv="refresh" content="1;URL=./nacslist.cfm">
