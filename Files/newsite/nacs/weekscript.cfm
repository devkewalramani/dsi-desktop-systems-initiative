...
<cfoutput>
<cfif #dateformat(form.bdate,'dddd')# eq 'Monday'>

<cfquery name="schedulecheck" datasource="newdsi">
Select *
from nacsschedule
where weekof=#parsedatetime(form.bdate)#
</cfquery>
	
	<cfif #dateformat(schedulecheck.weekof,'d/m/yyyy')# neq #dateformat(form.bdate,'d/m/yyyy')#>
	<cfquery name="addtech" datasource="newdsi">
	INSERT INTO nacsschedule (weekof,mon,tues,wed,thur,fri) Values ('#form.bdate#','#form.mon#','#form.tues#','#form.wed#','#form.thur#','#form.fri#')
	</cfquery>
	<div align="center"><span class="burgundy"><strong>Scheduled Added</strong></span><br>
	  <span class="burgundy"><strong>Refreshing Page</strong> </span></div>
	<meta http-equiv="refresh" content="1;URL=../index.cfm">
	
	<cfelseif #dateformat(schedulecheck.weekof,'d/m/yyyy')# eq #dateformat(form.bdate,'d/m/yyyy')#>
	<cfquery name="updateschedule" datasource="newdsi">
	UPDATE nacsschedule SET mon='#form.mon#',tues='#form.tues#',wed='#form.wed#',thur='#form.thur#',fri='#form.fri#' WHERE ID=#schedulecheck.ID#
	</cfquery>
	<div align="center"><span class="burgundy"><strong>Scheduled Updated</strong></span><br>
	  <span class="burgundy"><strong>Refreshing Page</strong> </span></div>
	<meta http-equiv="refresh" content="1;URL=../index.cfm">
	</cfif>


<cfelseif #dateformat(form.bdate,'dddd')# neq 'Monday'>
<div align="center" class="burgundy"><strong>Not a valid date for a week begining<br>
  Please try again
</strong></div>
<meta http-equiv="refresh" content="1;URL=weekly.cfm">
