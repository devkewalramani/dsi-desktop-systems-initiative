...
<cfform method="post" action="record.cfm">
  <p align="center" class="burgundy"><strong>Please enter the customers last name</strong></p>
  <p align="center">    <cfinput type="text" name="lname" tabindex="0" required="yes" message="Please enter a last name to search">
  </p>
  <p align="center">      <input type="submit" value="Search" tabindex="1">
    </p>
</cfform>
