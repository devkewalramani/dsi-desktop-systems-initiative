...
<cfquery name="updateemp" datasource="newdsi">
Select *
from nacslist
where id=#url.recordID#
</cfquery>

<p align="center" class="burgundy"><strong>NACS Update Employee</strong></p>
...
<cfoutput query="updateemp">
<form name="form" method="post" action="updatescript.cfm">
<tr bgcolor="##FFFFFF">
<input type="hidden" name="id" value="#id#">
<td><input type="text" name="lname" value="#lname#"></td>
<td><input type="text" name="fname" value="#fname#"></td>
<td><input type="text" name="nextel" value="#nextel#"></td>
<td><input type="text" name="email" value="#email#"></td>
</tr>
<tr bgcolor="##FFFFFF">
  <td colspan="4"><div align="center">
    <input type="submit" name="Submit" value="Update" tabindex="5">
  </div></td>
  </tr>
</form>
</cfoutput>
