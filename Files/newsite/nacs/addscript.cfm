...
INSERT INTO nacslist (lname,fname,nextel,email) VALUES ('#form.lname#','#form.fname#','#form.nextel#','#form.email#')
</cfquery>
<cfoutput>
  <p align="center" class="burgundy"><strong>Employee #form.lname#, #form.fname# has been added
  </strong></p>
