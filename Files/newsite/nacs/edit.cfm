...
<cfquery name="editrecord" datasource="newdsi">
select id,lname,fname,logon,context
from master
where id=#url.id#
</cfquery>
...
<table width="100%"  border="0" bgcolor="##CCCCCC">
  <tr bgcolor="##eeeeee" class="burgundy">
    ...
    <th scope="col"><strong>B1 ID </strong></th>
  ...
  <tr bgcolor="##FFFFFF">
    ...
    <td>#lname#&nbsp;</td>
    <td>#fname#&nbsp;</td>
    <td><input type="text" name="logon" value="#logon#"></td>
