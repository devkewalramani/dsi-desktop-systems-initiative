...
UPDATE master SET logon='#form.logon#',context='#form.context#',loc='#form.loc#', flr='#form.flr#', office='#form.office#',ph='#form.ph#', wrkhrs='#form.wrkhrs#', blkberry='#form.blkberry#', mtype='#form.mtype#', dispo='#form.dispo#', itemdesc='#form.desc#', serial='#form.serial#', replacemodel='#form.model#', status='#form.status#',  comment='#form.comment#' Where ID=#form.ID#
</cfquery>
<cfoutput>
