...
Select *
From master
Where func='#form.funcname#' AND lname='#FORM.lname#' and actualdate is not null
</cfquery>
...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
	...
	<!--display information-->
	<center><strong><font class="burgundy">PLEASE SELECT WHICH DEVICE YOU WANT TO RESCHEDULE</font></strong></center><br>
	<center><a href="javascript:history.back(1)"><img src="./images/back.jpg" border="0"></a></center>
<br>
	...
	<cfoutput query="lookup">
      <tr bgcolor="##FFFFFF">
	  <td bgcolor="##eeeeee"><div align="center"><a href="javascript:popUp('functiondata2.cfm?id=#id#')" class="burgundy"><strong>RESCHEDULE</strong></a></div></td>
