...
<cfif #loc# eq 'EROC' OR #loc# eq 'NY EROC'>
  <div align="center"><strong class="burgundy">EROC users can only be scheduled by SATT
      <br>
      Please call Pam Andrews x1324 <br>
      OR Patricia Welsh-Gordon x6743</strong>
      <br>
