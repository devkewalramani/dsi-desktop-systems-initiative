...
function popUpmigration(URL) {
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=315,height=300,left = 345.5,top = 273');");
}
// End -->
</script>
<style type="text/css">
...
<table width="100%"  border="0" cellpadding="1" cellspacing="1" bgcolor="##cccccc">
  ...
  <tr bgcolor="##FFFFFF">
    ...
    <td>
      <div align="center">
        <input type="button" value="Reschedule  Migration" onClick="javascript:popUpmigration('./migration/index.cfm?id=#id#&reschedule=1')">
      </div>
    </td>
  </tr>
</table>
