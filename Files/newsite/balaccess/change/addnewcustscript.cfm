...
INSERT INTO master (grp,func,lname,fname) VALUES ('#FORM.grp#','#FORM.func#','#FORM.lname#','#FORM.fname#')
</cfquery>
<cfoutput>
<cfmail from="DSI Add User" to="#form.balfname#.#form.ballname#@ny.frb.org" subject="User #FORM.lname#, #FORM.fname# Added">
