...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                <td valign="top"><!-- InstanceBeginEditable name="mainbody" -->Enter Serial #<cfoutput>
                  <cfform name="form" method="post" action="reassignsearch.cfm">

    <cfinput name="serial" type="text" size="25" maxlength="25" required="yes" message="Please enter a serial number to reassign">

	<input name="func" value="#url.func#" type="hidden">
