...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
	...
	<tr>
        <th bgcolor="#CCCCCC" scope="col"><span class="style1 style5">ID</span></th>
		<th bgcolor="#CCCCCC" scope="col"><span class="style1 style5">Name</span></th>
        <th bgcolor="#CCCCCC" scope="col"><span class="style1 style5 style5">Function</span></th>
        <th bgcolor="#CCCCCC" scope="col"><span class="style1 style5 style5">Type</span></th>
        <th bgcolor="#CCCCCC" scope="col"><span class="style1 style5 style5">Serial</span></th>
        <th bgcolor="#CCCCCC" scope="col"><span class="style1 style5 style5">Status</span></th>
      </tr>
	<cfoutput query="lookup">
	<tr bgcolor=###IIF(lookup.currentrow MOD 2,DE ('FFFFFF'),DE ('dddddd'))#>
        <td><a href="reassignasset.cfm?recordID=#ID#" class="style5">Click to Select</a></td>
		<td><span class="style5">#lname#,#fname#&nbsp;</span></td>
        <td><span class="style5">#func#&nbsp;</span></td>
		<td><span class="style5">#mtype#&nbsp;</span></td>
		<td><span class="style5">#serial#&nbsp;</span></td>
