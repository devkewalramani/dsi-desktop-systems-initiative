...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                ...
                <div align="center"><span class="burgundy"><strong> ADD A NEW CUSTOMER</strong></span><br>
                </div>
				<cfoutput>
                <cfform method="post" action="addnewcustscript.cfm">
  <p align="center"><strong>PLEASE LOOK UP CUSTOMER IN <span class="burgundy">LOTUS NOTES</span> TO VERIFY ACCURATE SPELLING OF THIER FIRST AND LAST NAMES</strong></p>
  Group:
  <input type="text" value="#url.grp#" name="grp" readonly="yes">
  Function:
  <input type="text" value="#url.func#" name="func" readonly="yes">
  <p><strong>First Name:</strong>      
    <cfinput type="text" name="fname" required="yes" message="Please enter the new users first name">
   </p>
  <p><strong>Last Name:</strong>    
    <cfinput type="text" name="lname" required="yes" message="Please enter the new users last name">
  </p>
       ...
       <p align="left" class="burgundy"><strong>BAL requesting addition?</strong> <em>(This emails the BAL, please include this information)</em> <br>
         ...
         <cfinput name="balfname" type="text" required="yes" message="Please enter the BAL's first name"  >
         <strong>Last name</strong>
         <cfinput name="ballname" type="text" required="yes" message="Please enter the BAL's last name">
</p>
       <hr>
