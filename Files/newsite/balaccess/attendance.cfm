...
Select *
From master
Where oattended IS NOT NULL and func='#url.func#'
Order by lname ASC
</cfquery>
<cfoutput>
...
<table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#999999">
  <tr bgcolor="#CCCCCC" class="burgundy">
    <th scope="col"><div align="left"><strong>Last Name&nbsp;</strong></div></th>
    <th scope="col"><div align="left"><strong>First Name&nbsp;</strong></div></th>
    <th scope="col"><div align="left"><strong>Date&nbsp;</strong></div></th>
    <th scope="col"><div align="left"><strong>Session&nbsp;</strong></div></th>
    <th scope="col"><div align="left"><strong>Attended?&nbsp;</strong></div></th>
    </tr>
<cfoutput query="attended">
  <tr bgcolor=###IIF(attended.currentrow MOD 2,DE ('FFFFFF'),DE ('eeeeee'))#>
    <td>#lname#&nbsp;</td>
    <td>#fname#&nbsp;</td>
