...
UPDATE master SET midate='#form.midate#', actualdate='#form.midate#', mtype='#form.mtype#',dispo='#form.dispo#' WHERE ID=#form.ID#
</cfquery>
<cfoutput>
<p>Customer #Form.name# has been Scheduled<br>
  You will be re-directed in a moment! </p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</cfoutput>
<meta http-equiv="refresh" content="1;URL=./adminschedule.cfm">
