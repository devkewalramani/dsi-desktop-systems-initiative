...
UPDATE master SET actualdate='#form.resch#',mtype='#form.mtype#',dispo='#form.dispo#' WHERE ID=#form.ID#
</cfquery>
<cfoutput>
<p>Customer #Form.name# has been updated<br>
  You will be re-directed in a moment! </p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</cfoutput>

<cfmail from="BAL Admin Scheduling" to="ny.dsi.migration.scheduler@ny.frb.org" cc="nynacs.team@ny.frb.org" bcc="glen.radziminski@ny.frb.org" subject="User #Form.name# has been rescheduled">

The following User has been rescheduled by the BAL Admin Update Tool

#form.name#

Previous 
Date: #dateformat(FORM.oldactual,'d/m/yyyy')#
...
<meta http-equiv="refresh" content="1;URL=./adminupdateschedule.cfm">
