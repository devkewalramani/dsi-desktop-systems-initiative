...
UPDATE master SET midate='#form.midate#', actualdate='#form.midate#', stime='#form.stime#', dispo='#form.dispo#', status='#form.status#' WHERE ID=#form.ID#
</cfquery>
  

<cfoutput>
  <div align="center"><span class="burgundy"><strong>
