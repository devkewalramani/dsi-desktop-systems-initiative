...
<style type="text/css">
<!--
.style10 {color: #681E15}
-->
</style>
<style type="text/css">
<!--
.style11 {color: #560808}
-->
</style>
<!-- InstanceEndEditable -->
...
Order by lname ASC
	...
	<tr valign="bottom" bgcolor="#eeeeee" class="burgundy">
        <th scope="col"><div align="center" class="style7"></div></th>
		...
		<th scope="col"><div align="center" class="style8"><strong>Item Desc</strong></div></th>
      </tr>
	<cfoutput query="lookup">
	 <form method="post" action="adminschedulescript.cfm" target="_blank">
	 ...
	 <input type="hidden" name="name" value="#fname# #lname#">
      <tr bgcolor="##FFFFFF">
		...
		<td><span class="style6"><span class="style9 style10 style11">#lname#,#fname#</span>&nbsp;</span></td>
		 <td><input type="text" name="midate" value="#dateformat(actualdate,'m/d/yyyy')#" size="10"></td>
		 <td><select name="stime">
	  <option value="#stime#">#timeformat(stime,'hh:mm tt')#</option>
	  <option value=""></option>
