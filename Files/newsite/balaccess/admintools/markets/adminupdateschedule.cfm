...
Select *
From master
Where func='Regs' and actualdate is not null
Order by lname ASC
</cfquery>
	...
	<tr valign="bottom" bgcolor="##CCCCCC" class="burgundy">
        ...
        <th scope="col"><div align="center" class="style8"><strong>Scheduled Date </strong></div></th>
        <th scope="col"><strong>Re-Schedule to </strong></th>
