...
SELECT *
FROM master
Where actualdate=#parsedatetime(url.miday3)# and func='#url.func#'
ORDER by stime ASC
</cfquery>
<div align="center" class="burgundy"><strong><cfoutput>#dateformat(url.miday3,'m/d/yyyy')#</cfoutput>
    <br>
</strong></div>
