...
<title>BAL Attachment F page</title>
<!-- InstanceEndEditable -->
...
Select *
From master
Where func='#form.func#' and lname='#form.lname#' and attachstatus is not null
</cfquery>
...
<table width="100%" cellpadding="1" cellspacing="2" bgcolor="##cccccc">
  ...
  <cfloop query="lookup">
<cfif #attachstatus# eq 'pending'>
  <tr bgcolor="##FFFFFF">
    <td><a href="attachment.cfm?recordID=#ID#" class="style5">Pending</a>&nbsp;</td>
  ...
  <cfelseif #attachstatus# eq 'pendingrevised'>
  <tr bgcolor="##FFFFFF">
    <td><a href="attachment2.cfm?recordID=#ID#" class="style5">Revision Pending Approval</a>&nbsp;</td>
    <td><span class="style5">#lname#, #fname#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#func#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
...
<cfelseif #attachstatus# eq 'revisionapproved'>
  <tr bgcolor="##FFFFFF">
    <td><a href="attachment2.cfm?recordID=#ID#" class="style5">Approved to Revise</a>&nbsp;</td>
    <td><span class="style5">#lname#, #fname#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#func#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
  ...
  <cfelseif #lookup.attachstatus# eq 'balrevision'> 
   <tr bgcolor="##FFFFFF">
    <td><a href="attachment2.cfm?recordID=#ID#" class="style5">BAL to revise</a></td>
    <td><span class="style5">#lname#,#fname#&nbsp;</span>&nbsp;</td>
	<td><span class="style5">#func#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Dateformat(actualdate,'m/d/yyyy')#&nbsp;</span>&nbsp;</td>
    <td><span class="style5">#Timeformat(stime,'hh:mm tt')#&nbsp;</span>&nbsp;</td>
