...
<cfoutput>
<cfif #form.edit# eq 'cust'>
<cfquery name="updatemaster" datasource="newdsi">
UPDATE master SET attachstatus='revisionapproved' WHERE ID=#form.id#
</cfquery>
<cfmail from="DSI WEBSITE" to="#form.fname#.#form.lname#@ny.frb.org" subject="Your Attachment F has been approved for revision">

Your BAL has approved your request to make changes to your Attachment F.  Please click on the link below
http://www.it.ny.frb.org/wcsd-dsi/attachmentf/index.cfm

If you cannot click on the link then cut and paste the link into your web browser. 

Thank you

DSI Staff
</cfmail>
<cfelseif #form.edit# eq 'bal'>
<cfquery name="updatemaster" datasource="newdsi">
UPDATE master SET attachstatus='balrevision' WHERE ID=#form.id#
</cfquery>
</cfif>

<cfmail from="DSI WEBSITE" to="dev.kewalramani@ny.frb.org,vincent.gulizio@ny.frb.org,larry.koenig@ny.frb.org,michael.tudor@ny.frb.org" subject="#form.fname#, #form.lname# has requested a revision to his/her Attachment F">

#form.fname# #form.lname# has requested a revision to his/her Attachment F
...
<p align="center" class="burgundy"><strong>Thank you<br>
  Refreshing Page...</strong></p>
<meta http-equiv="refresh" content="3;URL=record2.cfm?func=#form.func#">
</cfoutput>
