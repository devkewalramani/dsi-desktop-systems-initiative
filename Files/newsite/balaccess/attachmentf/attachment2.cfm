...
<p align="center" class="burgundy"><strong>Attachment F- Customer Migration information Worksheet</strong></p>
	...
	<form name="form" method="post" action="approveattach2.cfm">
	<input type="hidden" name="ID" value="#url.recordID#">
	<input type="hidden" name="attachdate" value="#dateformat(todaysdate,'m/d/yyyy')#">
    <table width="100%"  border="0">
      ...
      <tr>
        ...
        <td><input name="bal" type="text" value="#attach.bal#" readonly="yes"></td>
    ...
    <div align="center">
      ...
      <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
       ...
       <div align="left">
         ...
         <p align="center"><br>
                      <input type="submit" name="Submit" value="Approve Revision">
                      </form>
                    </p>
            </p>
       </div>
