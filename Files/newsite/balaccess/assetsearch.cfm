...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                <td valign="top"><!-- InstanceBeginEditable name="mainbody" -->Please type the serial # you want to find<cfoutput>:
                      <form name="form" method="post" action="assetinfo.cfm">
  <p>
    <input name="serial" type="text" size="50" maxlength="50">
</p>
<input type="hidden" name="funcname" value="#url.func#">
  <p>
