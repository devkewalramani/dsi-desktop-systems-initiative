...
<div align="center">
                ...
                <table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#cccccc">
                  <tr bgcolor="#eeeeee">
                    <th colspan="2" align="center" valign="top" class="burgundy">TEAM 1 TOOLS </th>
                    </tr>
                  <tr bgcolor="#FFFFFF">
                    <td align="center" valign="top" class="style2 style4"><strong><a href="team1.cfm" target="_blank">Enter Times</a></strong></td>
                    <td align="center" valign="top" class="style4 style2"><strong><a href="../issue/index.cfm" target="_blank">Report an Issue</a></strong></td>
                  </tr>
                  <tr bgcolor="#FFFFFF">
                    <td width="50%" align="center" valign="top" class="style2 style4"><strong><a href="../viewattach/index.cfm" target="_blank">View Attachment F Pipline </a></strong></td>
                    <td width="50%" align="center" valign="top" class="style4 style2"><a href="migrations.cfm" target="_blank"><strong>Hard Drive Prep Report</strong></a><strong> </strong></td>
                  </tr>
                </table>
