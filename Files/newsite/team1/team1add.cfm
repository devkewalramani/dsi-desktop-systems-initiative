...
INSERT INTO teamone (edate,fname,lname,tech,type,model,status,hdd,sysprep,joinrb,policy,mapk,otherapps,context,rr) VALUES('#FORM.Date#','#FORM.fname#','#FORM.lname#','#FORM.tech#','#FORM.type#','#FORM.model#','#FORM.status#','#FORM.t1#','#FORM.t2#','#FORM.t3#','#FORM.t4#','#FORM.t5#','#FORM.t6#','#FORM.t7#','#FORM.t8#')
</cfquery>
<br>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><html><!-- InstanceBegin template="/Templates/IT2.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
...
<meta http-equiv="refresh" content="1;URL=./team1.cfm">
