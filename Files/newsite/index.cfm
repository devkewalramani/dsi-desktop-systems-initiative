<cfquery name="index" datasource="newdsi">
...
<cfquery name="countnum" datasource="newdsi">
        ...
        <tr> 
          <td valign="top" bgcolor="#FFFFFF"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="4">
              <tr>
                <td width="41%" rowspan="2" align="left" valign="top"><img src="images/dsilogo.jpg" alt="DSI Logo" width="187" height="67"></td>
                <td width="59%" align="left" valign="top" bgcolor="#EEEEEE"><div align="right" class="style1">
                  CUSTOMER SEARCH </div></td>
              </tr>
              <tr>
                <td align="left" valign="middle" bgcolor="#EEEEEE"><form action="search/index.cfm" method="post" target="_blank">
                  <div align="right">
                        <span class="style1">LAST NAME</span>                      
                      <input type="text" size="30" maxlength="50" name="lname">
...
<tr>
<td><div align="center"><a href="nacs/index.cfm?error=0" target="_blank" onfocus="this.blur()">NACS Admin</a></div></td>
</tr>
<tr>
  <td><div align="center"><a href="satt/index.cfm?error=0" target="_blank" onfocus="this.blur()">SATT Admin</a></div></td>
</tr>
<tr>
  <td><div align="center"><a href="csc/index.cfm?error=0" target="_blank" onfocus="this.blur()">CSC Admin </a></div></td>
</tr>
<tr>
</tr>
</table>
