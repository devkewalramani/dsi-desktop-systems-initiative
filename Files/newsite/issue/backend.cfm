<cfquery name="newentry" datasource="DSI">
INSERT INTO migration_issue (opdate,Assignee,Status,Description,Solution) VALUES('#FORM.Date#','#FORM.Assignee#','#FORM.Status#','#FORM.Description#','#FORM.Solution#')
</cfquery>
<br>
...
<center><p class="burgundy"><strong>Your new issue was reported successfully! <br>
</strong>
<br>
<strong>You may now
</strong></p>
<a href=""><img src="../balaccess/images/close.jpg" width="153" height="26" border="0"  class="burgundy" onClick="window.close()"></a></center>
