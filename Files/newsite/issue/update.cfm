...
UPDATE migration_issue SET opdate='#FORM.Date#',Assignee='#FORM.Assignee#',Status='#FORM.Status#',Description='#FORM.Description#',Solution='#FORM.Solution#' WHERE IssueID=#IssueID#
</cfquery>
<p align="center" class="burgundy"><strong>Your Data has been updated<br>
  You will be re-directed in a moment!</strong></p>
