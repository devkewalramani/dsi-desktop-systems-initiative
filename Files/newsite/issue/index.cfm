...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=700,height=660');");
}
// End -->
</script>
...
<a href="javascript:popUp('./newentry.cfm')">Report New Issue</a><br>
<br>
<div style="border:0px; width:615px; height:400px; overflow-y:auto; overflow-x:auto;">			  
<table width="590" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#CCCCCC">
...
<td><a href="migrationissuedetail.cfm?recordID=#IssueID#" class="style1 style2">DSI-000#IssueID#</a></td>
<td><span class="style1 style2">#dateformat(opdate,'m/d/yyyy')#</span></td>
<td><span class="style1 style2">#Assignee# </span></td>
<td><span class="style1 style2">#Status# </span></td>
<td><span class="style1 style2">
  <textarea cols="15" rows="4" readonly>#Description#</textarea>
</span></td>
<td><span class="style1 style2">
  <textarea cols="15" rows="4" readonly>#Solution#</textarea>
</span></td>
</tr>
</cfoutput> 
</table>
