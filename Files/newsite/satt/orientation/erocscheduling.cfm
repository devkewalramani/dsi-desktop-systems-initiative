...
<cfquery name="eroc" datasource="newdsi">
Select *
from master
where func='#form.team#' and loc='EROC' and loc is not null or func='#form.team#' and loc='NY EROC' and loc is not null
order by lname asc
</cfquery>
  ...
  <table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#CCCCCC">
    <tr bgcolor="#eeeeee">
	  <th class="burgundy" scope="col">Record #</th>
      <th class="burgundy" scope="col">Function</th>
      <th class="burgundy" scope="col">Name</th>
	  <th scope="col"></th>
    </tr>
<cfoutput query="eroc">
    <tr bgcolor="##FFFFFF">
      ...
      <td>#func#</td>
      <td>#lname#, #fname#</td>
	  <td><input type="button" value="Update" onClick="javascript:popUp('./index.cfm?id=#id#')"></td>
    </tr>
</cfoutput>	
  </table>
