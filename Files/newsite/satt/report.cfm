...
SELECT *
FROM master
WHERE func='#form.team#' and odate Between #parsedatetime(form.bdate)# AND #parsedatetime(form.edate)# and odate is not null
Order BY func ASC
</cfquery>
<style type="text/css">
<!--
...
<tr align="left" valign="bottom" bgcolor="#eeeeee" class="burgundy">
	...
	<th scope="col"><strong>Orientaion BU</strong></th>
