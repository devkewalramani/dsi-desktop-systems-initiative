...
<table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="##cccccc">
  <tr bgcolor="##eeeeee">
    <th colspan="2" align="center" valign="top" class="burgundy">SATT TOOLS </th>
    </tr>
  <tr bgcolor="##FFFFFF">
    <td width="50%" align="center" valign="top" class="burgundy"><a href="schedule.cfm" target="_blank">ORIENTATION SCHEDULE</a></td>
    <td width="50%" align="center" valign="top"><span class="burgundy"><a href="tschedule.cfm" target="_blank">XP TRAINING SCHEDULE</a> </span></td>
  </tr>
  <tr bgcolor="##FFFFFF">
    <td align="center" valign="top" class="burgundy"><a href="attendeddate.cfm">ORIENTATION ATTENDANCE FORM </a></td>
    <td align="center" valign="top"><span class="burgundy"><a href="attendeddate2.cfm">XP TRAINING  ATTENDANCE FORM </a></span></td>
  </tr>
  <tr bgcolor="##FFFFFF">
    <td align="center" valign="top" class="burgundy"><a href="training.cfm" target="_blank">XP TRAINING DATES</a></td>
    <td align="center" valign="top"><a href="./orientation/scheduling.cfm" target="_blank">SCHEDULE EROC ORIENTATION</a> </td>
  </tr>
</table>
