...
SELECT *
FROM master
WHERE func='#form.team#' and tdate Between #parsedatetime(form.bdate)# AND #parsedatetime(form.edate)# and tdate is not null
Order BY func ASC
</cfquery>
<style type="text/css">
<!--
...
<tr align="left" valign="bottom" bgcolor="#eeeeee" class="burgundy">
...
<cfoutput query="migrations">
  ...
  <td  scope="col">#dateformat(tdate,'m/d')#</td>
  <td  scope="col">#tsession#</td>
  <td  scope="col">#ph#</td>
  <td scope="col">#tbu#</td>
  <td scope="col">#tattended#</td>
  </tr>
</cfoutput>
</table>
