...
<table width="100%"  border="0" cellpadding="2" cellspacing="2" bgcolor="#CCCCCC">
  <tr valign="top" bgcolor="#EEEEEE" class="burgundy">
    <th scope="col">SEARCH BY FUNCTION </th>
    <th scope="col">SEARCH BANKWIDE </th>
  </tr>
  <tr valign="top" bgcolor="#FFFFFF">
    <td>
	<center>
	<form name="form" method="post" action="report.cfm" >
  <p>
 ...
 <p>Select The Group <br>
       ...
       <p><span class="style1">Select The Function</span>:<br> 
         <SELECT NAME="Team">
         <OPTION>                    </OPTION>
		 <OPTION>                    </OPTION>
		 <OPTION>                    </OPTION>
    ...
    <td>
	<CENTER>
	<form name="form" method="post" action="report2.cfm" >
  <p>
  Please enter your start date:
  <br>
  <input type=text name='bdate' size=10 maxlength=10 value='...'>
