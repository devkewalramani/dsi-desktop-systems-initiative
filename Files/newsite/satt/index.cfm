...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
				...
				<cfif #url.error# eq 0>
<form name="form" method="post" action="sattpage.cfm">
       
	   <p>&nbsp;	     </p>
	   <p align="center">
	     <input type="text" name="auth" value="SATTAdmin" readonly="yes">
	     </p>
...
<form name="form" method="post" action="sattpage.cfm">
	   ...
	   <p align="center">
	         ...
	         <input type="text" name="auth"  class="burgundy"value="SATTAdmin" readonly="yes" style="background-color:#eeeeee ">
	         </span></p>
