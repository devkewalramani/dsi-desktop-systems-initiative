...
<cfform name="form" method="post" action="pass.cfm" enctype="application/x-www-form-urlencoded">
  <p align="center" class="style1">
  You are accessing a<br>restricted page!
    ...
    <div align="center">
      <p>
        <select name="user">
          ...
          <option value="Team1Admin">Team1Admin</option>
		  <option value="Admin">Admin</option>
		  <option value="Team2Admin">Team2Admin</option>
        </select>
</p>
          
  Please Enter Your Admin Password</div>
    <p align="center">      <cfinput type="password" name="pass" required="yes" message="You Need to Enter your Team 1 Password">
    </p>
    <p align="center">
