...
<cfform name="form" method="post" action="results.cfm">
  <p>
  <cfinput name="lname" type="text" size="50" maxlength="50" required="Yes" message="Please type in the last name of the customer you are searching for">
</p>
  <p>
