...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
	...
	<tr valign="bottom" bgcolor="#CCCCCC" class="burgundy">
        ...
        <th scope="col"><div align="center" class="style8"><strong>Group</strong></div></th>
        <th scope="col"><div align="center" class="style8"><strong>Function</strong></div></th>
        <th scope="col"><div align="center" class="style8"><strong>Location</strong></div></th>
        <th scope="col"><div align="center" class="style8"><strong>Floor</strong></div></th>
        <th scope="col"><div align="center" class="style8"><strong>Phone</strong></div></th>
      </tr>
	<cfoutput query="lookup">
      <tr bgcolor="##FFFFFF">
        <td><a href="view.cfm?recordID=#ID#" class="style6 style6">View More Information</a></td>
		<td><span class="style6">#lname#,#fname#&nbsp;</span></td>
        <td ><span class="style6">#grp#&nbsp;</span></td>
