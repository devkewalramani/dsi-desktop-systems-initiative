...
<cfset firstavailabledate=dateformat(now(),'m/d/yyyy')+1>
...
<cfset operiod=#firstavailabledate#+1>
<cfif #form.actual# neq "">
<cfset operiod2=#dateformat(form.actual,'m/d/yyyy')#-1>
</cfif>
...
<cfif #dateformat(form.actual,'m/d/yyyy')# gte #dateformat(firstavailabledate,'m/d/yyyy')# AND #checkm.count# lt 35 >
<cfquery name="balupdate" datasource="DSI">
UPDATE master SET loc='#form.loc#', flr='#form.flr#', office='#form.office#', ph='#form.ph#', wrkhrs='#form.wrkhrs#', blkberry='#form.blkberry#', mtype='#form.mtype#', dispo='#form.dispo#', itemdesc='#form.desc#', serial='#form.serial#', replacemodel='#form.model#', status='#form.status#', actualdate='#form.actual#', stime='#form.time#',lock='y' Where ID=#form.ID#
</cfquery>
...
<cfquery name="balupdate" datasource="DSI">
UPDATE master SET loc='#form.loc#', flr='#form.flr#', office='#form.office#', ph='#form.ph#', wrkhrs='#form.wrkhrs#', blkberry='#form.blkberry#', mtype='#form.mtype#', dispo='#form.dispo#', itemdesc='#form.desc#', serial='#form.serial#', replacemodel='#form.model#', status='#form.status#',odate='#form.odate#', osession='#form.osession#' Where ID=#form.ID#
</cfquery>
...
<br>
<meta http-equiv="refresh" content="1;URL=editschedule2.cfm?funcname=#form.funcname#&lname=#form.lname#">
<cfexit>

<cfelseif #dateformat(form.actual,'m/d/yyyy')# lt #dateformat(firstavailabledate,'m/d/yyyy')# AND #checkm.count# lt 35>
...
<cfelseif #dateformat(form.actual,'m/d/yyyy')# gte #dateformat(firstavailabledate,'m/d/yyyy')# AND #checkm.count# gte 35>
...
<cfif #form.tdate# eq "">
<cfquery name="balupdate" datasource="DSI">
UPDATE master SET loc='#form.loc#', flr='#form.flr#', office='#form.office#', ph='#form.ph#', wrkhrs='#form.wrkhrs#', blkberry='#form.blkberry#', mtype='#form.mtype#', dispo='#form.dispo#', itemdesc='#form.desc#', serial='#form.serial#', replacemodel='#form.model#', status='#form.status#' Where ID=#form.ID#
</cfquery>
...
<cfquery name="balupdate" datasource="DSI">
UPDATE master SET loc='#form.loc#', flr='#form.flr#', office='#form.office#', ph='#form.ph#', wrkhrs='#form.wrkhrs#', blkberry='#form.blkberry#', mtype='#form.mtype#', dispo='#form.dispo#', itemdesc='#form.desc#', serial='#form.serial#', replacemodel='#form.model#', status='#form.status#',tdate='#form.tdate#', tsession='#form.tsession#' Where ID=#form.ID#
</cfquery>
...
<cfcatch type="any">
<meta http-equiv="refresh" content="0;URL=editschedule2.cfm?lname=#form.lname#">
</cfcatch>
