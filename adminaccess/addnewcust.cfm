...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                ...
                <div align="center"><span class="burgundy"><strong>ADMIN ADD CUSTOMER TOOL	
                  </strong></span><br>
                </div>
                <form name="Team" method="post" action="addnewcustscript.cfm">
  <p align="center"><strong>PLEASE LOOK UP CUSTOMER IN <a href="http://assets.it.ny.frb.org/AssetTracking/" target="_blank">ASSET TRACKING</a> TO VERIFY ACCURATE SPELLING OF THIER NAME AS WELL AS THEIR GROUP AND FUNCTION INFO</strong></p>
  ...
  <p> <strong>Group</strong> <br>
       ...
       <hr noshade>
       <p align="left" class="burgundy"><strong>BAL requesting addition?</strong> <em>(This emails the BAL, please include this information)</em> <br>
         <strong>First name</strong>
         <input name="balfname" type="text" id="balfname" >
         <strong>Last name</strong>
         <input name="ballname" type="text" id="ballname">
</p>
       <hr>
       <p align="center" class="burgundy"><strong>*NOTE: PLEASE MAKE SURE THE GROUP AND FUNCTION INFORMATION ARE ACCURATE BEFORE ADDING CUSTOMER, THIS DIRECTLY EFFECTS REPORTS USED BY MANAGEMENT</strong></p>
       <div align="center"><BR>
