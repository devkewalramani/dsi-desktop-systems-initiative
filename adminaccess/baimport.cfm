...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
    ...
    <div align="center" class="burgundy"><strong>Importing Data<br>
  Please wait
    </strong></div>
    <cfquery name="asset" datasource="DSI">
	SELECT *
	FROM assettracking 
    </cfquery>
<table width="100%" cellpadding="2" cellspacing="2" bgcolor="#000000">
<tr bgcolor="#CCCCCC" class="burgundy">
  <th scope="col"><strong>Record Count</strong></th>
...
<cfquery name="cidinfo" datasource="DSI">
SELECT *
FROM CID 
...
INSERT INTO master (grp,func,lname,fname,logon,loc,ph,mtype,itemdesc,serial,hbu,comment) VALUES ('#cidinfo.grp#', '#asset.func#', '#asset.lname#', '#asset.fname#', '#cidinfo.logon#', '#cidinfo.loc#', '#cidinfo.ph#', '#asset.mtype#', '#asset.itemdesc#', '#asset.serial#', '#asset.hbu#', '#asset.comment#')
</cfquery>
...
<td>#mtype#</td>
<td>#serial#</td>
<td><em class="burgundy"><strong>Imported</strong></em></td>
</tr>
