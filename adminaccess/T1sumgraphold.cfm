...
SELECT DISTINCTROW [teamoneold].[tech], Avg([teamoneold].[hdd]) AS [hdd], Avg([teamoneold].[sysprep]) AS[sysprep], Avg([teamoneold].[gw]) AS [gw], Avg([teamoneold].[joinrb]) AS [joinrb], Avg([teamoneold].[policy]) AS [policy], Avg([teamoneold].[dns]) AS [dns], Avg([teamoneold].[mapk]) AS [mapk], Avg([teamoneold].[otherapps]) AS [otherapps], Avg([teamoneold].[context]) AS [context], Avg([teamoneold].[rr]) AS [rr]
FROM teamoneold
WHERE edate Between #parsedatetime(form.bdate)# AND #parsedatetime(form.edate)# AND type='#Form.type#'
GROUP BY [teamoneold].[tech]
</cfquery>
...
<text x="0" y="25" >Team 1 Average completion time of each step by Tech</text>
</g>
 <!--SubHeading-->
<g id="Heading2" font-family="Arial" font-size="16" >
<text x="130" y="45" >#form.type# For #form.bdate# to #form.edate#</text>
</g>
...
<!--Y Axis Labels-->
 ...
 <g stroke-width="1" stroke="##000000">
  ...
  <g fill="##00FFFF">
  <rect x="385" y="440" width="10" height="10" />
  </g>
  <g fill="##FF00FF">
 ...
 <rect x="285" y="460" width="10" height="10" />
  ...
  <g fill="##00FAC8">
  <rect x="385" y="460" width="10" height="10" />
  </g>
 </g>
 <!--legend text-->
<g font-family="Times New Roman" font-style="Bold" font-size="12">
<text x="-3" y="450">Install Hdd</text>
<text x="97" y="450">Sysprep</text>
<text x="197" y="450">GhostWalker</text>
<text x="297" y="450">Join RB</text>
<text x="397" y="450">Admin Policies</text>
<text x="-3" y="470">DNS Suffix</text>
<text x="97" y="470">App Install</text>
<text x="197" y="470">Other Apps</text>
<text x="297" y="470">Context</text>
<text x="397" y="470">Rapid Restore</text>
 </g>
...
<cfset grr=#NumberFormat(rr,'999')#*4>
 ...
 <g stroke-width="1" stroke="##000000" transform="matrix(1 0 0 -1 0 760)">
  ...
  <g fill="##88FF8E">
  <rect x="#xb3#" y="380" width="15" height="#NumberFormat(ggw,'999')#" />
  </g>
  <g fill="##FFFF00">
  <rect x="#xb4#" y="380" width="15" height="#NumberFormat(gjoinrb,'999')#" />
  </g>
  <g fill="##00FFFF">
  <rect x="#xb5#" y="380" width="15" height="#NumberFormat(gpolicy,'999')#" />
  </g>
  <g fill="##FF00FF">
  <rect x="#xb6#" y="380" width="15" height="#NumberFormat(gdns,'999')#" />
  </g>
  <g fill="##FF9900">
  <rect x="#xb7#" y="380" width="15" height="#NumberFormat(gmapk,'999')#" />
  </g>
  <g fill="##DD9B9B">
  <rect x="#xb8#" y="380" width="15" height="#NumberFormat(gotherapps,'999')#" />
  </g>
  <g fill="##6699CC">
  <rect x="#xb9#" y="380" width="15" height="#NumberFormat(gcontext,'999')#" />
  </g>
  <g fill="##00FAC8">
  <rect x="#xb10#" y="380" width="15" height="#NumberFormat(grr,'999')#" />
  </g>
 </g>
 <!-- Set Label Vars and Print Label Bars -->
 <cfset t1=375-#NumberFormat(ghdd,'999')#>
 <cfset t2=375-#NumberFormat(gsysprep,'999')#>
 <cfset t3=375-#NumberFormat(ggw,'999')#>
 <cfset t4=375-#NumberFormat(gjoinrb,'999')#>
 <cfset t5=375-#NumberFormat(gpolicy,'999')#>
 <cfset t6=375-#NumberFormat(gdns,'999')#>
 <cfset t7=375-#NumberFormat(gmapk,'999')#>
 <cfset t8=375-#NumberFormat(gotherapps,'999')#>
 <cfset t9=375-#NumberFormat(gcontext,'999')#>
 <cfset t10=375-#NumberFormat(grr,'999')#>
 ...
 <g fill="Black" font-family="Arial" font-size="7">
  ...
  <text x="#xl3#" y="#t3#" >#NumberFormat(gw,'999')#</text>
  <text x="#xl4#" y="#t4#" >#NumberFormat(joinrb,'999')#</text>
  <text x="#xl5#" y="#t5#" >#NumberFormat(policy,'999')#</text>
  <text x="#xl6#" y="#t6#" >#NumberFormat(dns,'999')#</text>
  <text x="#xl7#" y="#t7#" >#NumberFormat(mapk,'999')#</text>
  <text x="#xl8#" y="#t8#" >#NumberFormat(otherapps,'999')#</text>
  <text x="#xl9#" y="#t9#" >#NumberFormat(context,'999')#</text>
  <text x="#xl10#" y="#t10#" >#NumberFormat(rr,'999')#</text>
 </g>
 <!--Increment all VARS -->
<cfset srow=#srow#+1>
