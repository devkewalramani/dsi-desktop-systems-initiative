<cfquery name="group" datasource="DSI">
SELECT *
FROM grouptotal
ORDER BY ID ASC 
</cfquery>
...
<cfquery name="done" datasource="DSI">
...
<cfquery name="group2" datasource="DSI">
select *
from groupmonth
where grp='#group.grp#'
</cfquery>
