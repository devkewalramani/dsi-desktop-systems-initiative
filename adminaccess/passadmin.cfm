...
<cfquery name="passlookup" datasource="DSI">
Select *
from functionpass
order by ID ASC				
</cfquery>
...
<table width="100%"  border="0" cellpadding="5" cellspacing="5" bgcolor="##000000">
  <tr align="left" bgcolor="##CCCCCC" class="burgundy">
    ...
    <th width="50%" scope="col">Function&nbsp;</th>
    <th width="50%" scope="col">Password&nbsp;</th>
  </tr>
<cfoutput query="passlookup">
  <tr bgcolor=###IIF(passlookup.currentrow MOD 2,DE ('FFFFFF'),DE ('dddddd'))#>
    <td width="50%">#func#</td>
    <td width="50%">#pass#</td>
</cfoutput>
</tr>
