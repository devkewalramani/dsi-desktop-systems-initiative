...
UPDATE master SET lname='#form.newlname#', fname='#form.newfname#' WHERE ID=#ID#
</cfquery>
<cfoutput>
<p>Device has been reassigned to #Form.newlname#, #Form.newfname# <br>
...
<meta http-equiv="refresh" content="2;URL=./search2.cfm">
