<cfquery name="techs1" datasource="DSI">
...
<text x="50" y="25" >Team 1 Technician Productivity Report</text>
</g>
 <!--SubHeading-->
...
<cfset xml = #ToString(techs1old)#>
<cffile action="write" file="#getDirectoryFromPath(getTemplatePath())#techs1old.svg" output="#xml#">
<cflocation url="techs1old.svg">