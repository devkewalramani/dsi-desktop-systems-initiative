...
<p align="center" class="burgundy"><strong>Totals to Date (Starting Feb 1, 2004)</strong></p>
<cfset totalscheduled=125+58+#report3.schtot#>
<cfset totalmigrated=#report2.mitot#>
<cfset totalvariance=#totalscheduled#-#totalmigrated#>
<table width="100%"  border="0" cellpadding="2" cellspacing="5" bgcolor="##000000">
  <tr bgcolor="##CCCCCC" class="burgundy">
  ...
  <tr bgcolor="##CCCCCC">
    <td colspan="2"><div align="center"><strong class="burgundy">Total Variance </strong></div></td>
    </tr>
  <tr bgcolor="##FFFFFF">
    <td colspan="2"><div align="center">#totalvariance#</div></td>
  </tr>
</table>
</cfoutput>
