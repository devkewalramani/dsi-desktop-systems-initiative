...
<!--set bar vars-->
<cfset gbar1a=gbar1*10>
<cfset gbar2a=gbar2*10>
<cfset gbar3a=gbar3*10>
<cfset gbar4a=gbar4*10>
<cfset gbar5a=gbar5*10>
<cfset gbar6a=gbar6*10>
<cfset gbar7a=gbar7*10>
<cfset gbar8a=gbar8*10>
<cfset gbar9a=gbar9*10>
<cfset gbar10a=gbar10*10>
<cfset gbar11a=gbar11*10>
<cfset gbar12a=gbar12*10>
<cfset gbar13a=gbar13*10>
<cfset gbar14a=gbar14*10>
<cfset gbar15a=gbar15*10>
<cfset gbar16a=gbar16*10>
...
<rect x="-25" y="50" width="570" height="370" />
</g>
<!--label axis-->
<g id="ylabel" font-family="Times New Roman" font-style="Bold" font-size="14" >
<text x="-300" y="0" transform="rotate(-90)">Number of Devices</text>
</g>
...
<text x="185" y="25" >Migration Analysis</text>
</g>
 <!--SubHeading-->
<g id="Heading2" font-family="Arial" font-size="16" >
<text x="100" y="45" >Total Migrated From #form.bdate# to #form.edate# -</text>
</g>
<!--Sub Heading2-->
<g id="Heading2" fill="red" font-family="Arial" font-size="16" >
<text x="420" y="45" > #totalnum#</text>
</g>
