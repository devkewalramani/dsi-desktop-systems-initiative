...
<!--display information-->
	<p class="style1">Team 1 Data Prior to Feb, 2004</p>
	<form name="range" method="post" action="T1sumgraphold3.cfm">
  <p>
  Please enter your start date:
  <br>
  <input type=text name="bdate" size=10 maxlength=10 value="12/1/2003" readonly="">
  <br>
  Please enter you end date:
  <br>    
  <input type=text name="edate" size=10 maxlength=10 value="1/31/2004" readonly="">
