...
<table width="715" height="385" border="0" cellpadding="0" cellspacing="1" >
  <tr>
    <td width="709" valign="top"> 
      <table width="711" height="314" border="0" cellpadding="0" cellspacing="1" >
  <tr>
    <td width="102" align="left" valign="top" bgcolor="#EEEEEE"><br>      <table width="42%" height="278"  border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td align="center" valign="top"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22">
          ...
          <param name="movie" value="detail2.swf">
          <param name="quality" value="high">
          <embed src="detail2.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
        </object></td>
      </tr>
      <tr>
        <td align="center" valign="top"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="22">
          <param name="BGCOLOR" value="">
          <param name="movie" value="detail3.swf">
          <param name="quality" value="high">
          <embed src="detail3.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="22" ></embed>
        </object></td>
      </tr>
      <tr>
...
<br>
<input name="Date" type="text" value="#DatePart("m",opdate)#/#DatePart("d",opdate)#/#DatePart("yyyy",opdate)#">
<br>
<select name="Assignee">#Assignee#
...
<br>
<textarea name="Description" cols="80" rows="7">#Description#</textarea>
<br>
<textarea name="Solution" cols="80" rows="7">#Solution#</textarea> 
<br>
<input type="submit" value="Update">
</form>
<form method="post" action="delete.cfm?ID=#IssueID#">
