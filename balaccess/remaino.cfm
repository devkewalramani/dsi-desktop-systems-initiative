...
<cfoutput>
  <p align="center" class="style1">FRB NY DSI Project<br>
    #url.func#<br>
	Remaining Customers to be Scheduled for Orientation</p>
...
<tr align="left" valign="top" bgcolor="#009999" class="style1">
	...
	<th width="8%" scope="col">Orientation Date&nbsp;</th>
    <th width="6%" scope="col">Session&nbsp;</th>
...
<cfif #dateformat(odate,'m/d/yyyy')# gte dateformat(now(),'m/d/yyyy') OR #dateformat(odate,'m/d/yyyy')# eq "">
    <tr align="left" valign="top"  bgcolor="##FFFFFF">
	<td width="15%" scope="col">#lname#, #fname#&nbsp;</td>
    <td width="8%" scope="col">#dateformat(odate,'m/d')#&nbsp;</td>
    <td width="9%" scope="col">#osession#&nbsp;</td>
