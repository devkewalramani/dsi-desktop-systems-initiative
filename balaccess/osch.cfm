        ...
        <tr> 
          <td valign="top" bgcolor="#FFFFFF"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="4">
              <tr>
                <td width="56%" align="left" valign="top"><img src="../images/nuLogo.jpg" alt="DSI Logo" width="277" height="90" border="0"></td>
                <td width="44%" colspan="2" align="right">&nbsp; </td>
              </tr>
            </table></td>
        </tr>
        <tr> 
...
year = year + 1900;
    ...
    // -- end hiding 
                ...
                <td width="51%" class="topmenu"><div align="right"><a href="http://www.it.ny.frb.org/dsi/">DSI Home </a> 
...
SELECT *
FROM master
Where odate <> null and odate=#parsedatetime(url.miday3)# and func='#url.func#'
ORDER by lname ASC
</cfquery>
