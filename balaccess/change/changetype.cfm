...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
              <tr>
                ...
                <div align="center"><span class="burgundy"><strong>CHANGE REQUEST FORM</strong></span>                    <br>
                </div>
				<cfoutput>
                <CFFORM name="form" method="post" action="changeform.cfm">
                  <div align="center"><span class="burgundy">TYPE OF REQUEST?<br>
                  </span>
				  <input type="hidden" name="func" value="#url.func#">
                      <cfselect name="type" required="yes" message="Please specify the type of request">
                        <option value="">Select</option>
                        <option value="asset">Re-Assign Asset</option>
