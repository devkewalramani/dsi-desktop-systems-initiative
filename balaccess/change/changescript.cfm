...
<cfoutput>
<cfif #form.requesttype# eq 'asset'>
<cfmail from="Change Request" to="dev.kewalramani@ny.frb.org,eric.okimoto@ny.frb.org,glen.radziminski@ny.frb.org,jonathan.shafer@ny.frb.org" subject="Re-Assign Asset Request">
#form.balfname# #form.ballname# from #form.func# is requesting a asset reassignment

Current user:#form.currentfname# #form.currentlname#
Asset Type: #form.assettype#
Serial: #form.serial#

Re-Assign To
#form.newfname# #form.newlname#

Thank you
DSI Website
</cfmail>
<div align="center"><span class="burgundy"><strong>Your Request has been submitted
      <br>
  Thank you</strong></span><br>
  

</div>
<cfelseif #form.requesttype# eq 'add'>
<cfmail from="Change Request" to="dev.kewalramani@ny.frb.org,eric.okimoto@ny.frb.org,glen.radziminski@ny.frb.org,jonathan.shafer@ny.frb.org" subject="Add New User Request">
#form.balfname# #form.ballname# from #form.func# is requesting a user addition
...
<cfelseif #form.requesttype# eq 'delete'>
<cfmail from="Change Request" to="dev.kewalramani@ny.frb.org,eric.okimoto@ny.frb.org,glen.radziminski@ny.frb.org,jonathan.shafer@ny.frb.org" subject="Delete a User Request">
#form.balfname# #form.ballname# #form.func# is requesting to delete a user

User:#form.fname# #form.lname#
Asset Type: #form.assettype#
Serial: #form.serial#
