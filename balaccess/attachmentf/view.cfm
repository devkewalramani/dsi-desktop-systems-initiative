...
<cfoutput>
  <hr align="left" width="100%" noshade>
    ...
    <hr align="left" width="100%" noshade>  
  <div align="center">
  <cfquery name="funcsoft" datasource="DSI">
  Select software
  from attachg
  where func='#attach.func#'
   ...
   <div align="left">
	 ...
	 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
       <tr>
         <th bgcolor="##CCCCCC" class="burgundy" scope="col">Do you need to revise this approved Attachment F? </th>
         </tr>
       <tr>
         <td><form name="form1" method="post" action="revise.cfm">
           <div align="center">
