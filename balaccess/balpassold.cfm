...
<table width="100%"  border="0" cellpadding="5" cellspacing="5" bgcolor="##000000">
  ...
  <tr bgcolor="##FFFFFF">
<td width="50%"><cfform name="form" method="post" action="functiondata.cfm?functionname=#funcname#" target="_blank">
  <div align="center">
...
<table width="100%"  border="0" cellpadding="5" cellspacing="5" bgcolor="##000000">
  <tr bgcolor="##FFFFFF">
    <td width="50%" bgcolor="##FFFFFF"><div align="center" class="burgundy"><a href="attachmentf/record.cfm?func=#form.team#" target="_blank">VIEW / APPROVE ATTACHMENT F's</a> </div></td>
    <td bgcolor="##FFFFFF"><div align="center" class="burgundy"><a href="attachmentf/record2.cfm?func=#form.team#" target="_blank">REVISE ATTACHMENT F 's</a></div></td>
  </tr>
</table>
<br>
<table width="100%"  border="0" cellpadding="5" cellspacing="5" bgcolor="##000000">
