...
<cfif #url.error# eq 1>
  <span class="style1">You Entered The Wrong Password Please Try Again!
  <form name="Team" method="post" action="balpass.cfm">
       ...
       <p><span class="style1">Select Your Function</span>:<br> 
         <SELECT NAME="Team">
         <OPTION>                    </OPTION>
		 <OPTION>                    </OPTION>
		 <OPTION>                    </OPTION>
    ...
    <input type="password" name="pass" style="background-color:#eeeeee
	 ">
    <br>
    Having a logon problem? please contact Eric Okimoto x2573, Glen Radziminski x6224 or Dev Kewalramani x2439 </p>
	   <bt>
	   <input name="submit" type="submit" id="submit" value="Login">
</form>
  </span>
  <cfelseif #url.error# eq 0>
<form name="Team" method="post" action="balpass.cfm">
       <p>Select Your Group <br>
         <SELECT NAME="Make" onChange="fillSelectFromArray(this.form.Team, ((this.selectedIndex == -1) ? null : team[this.selectedIndex-1]));">
           <OPTION VALUE="-1">NA
