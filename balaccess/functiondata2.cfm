...
<table width="700" border="0">
  <tr align="left" valign="bottom">
    <th valign="bottom" scope="col"><span class="style2">Location</span></th>
    <th valign="bottom" scope="col"><span class="style2">Floor</span></th>
    <th valign="bottom" scope="col"><span class="style2">Cube/Office</span></th>
	<th class="style2" scope="col">Phone</th>
    <th valign="bottom" scope="col"><span class="style2">Work Hours</span></th>
    <th valign="bottom" scope="col"><span class="style2">Black Berry</span></th>
    <th valign="bottom" scope="col"><span class="style2">Machine Type</span></th>
    <th valign="bottom" scope="col"><span class="style2">Disposition</span></th>
    <th valign="bottom" scope="col"><span class="style2">Machine Description</span></th>
    <th valign="bottom" scope="col"><span class="style2">Serial</span></th>
    <th valign="bottom" scope="col"><span class="style2">Replacement Model</span></th>
    <th valign="bottom" scope="col"><span class="style2">Status</span></th>
    <th align="left" valign="bottom" scope="col"><span class="style6">Orientation Date <span class="style5 style8"><strong><strong><strong>(m/d/yyyy)</strong></strong></strong></span></span></th>
    <th valign="bottom" scope="col"><span class="style2">Session</span></th>
    <th align="left" scope="col"><span class="style2">XP Training Date <span class="style6"><span class="style5 style8"><strong><strong><strong>(m/d/yyyy)</strong></strong></strong></span></span></span></th>
    <th valign="bottom" scope="col"><span class="style2">Session</span></th>
    <th align="left" valign="bottom" scope="col"><span class="style2">Migration Date <span class="style6"><span class="style5 style8"><strong><strong><strong>(m/d/yyyy)</strong></strong></strong></span></span></span></th>
    <th valign="bottom" scope="col"><span class="style2">Migration Time</span></th>
  </tr>
  <tr>
    <td><select name="loc">
    ...
    <td align="left" valign="bottom"><cfinput name="odate" type="text" value="#dateformat(odate,'m/d/yyyy')#" size="15" maxlength="15" required="no" message="Please Enter a valid Date" validate="date" class="style7"></td>
    ...
    <td align="left"><cfselect name="tdate">
