...
<title>Migration Calendar</title>
<!-- InstanceEndEditable -->
...
<cfoutput>
<strong><center class="burgundy">#url.func# Migration Calander</center></strong><br>
...
--->
        <td align="center">
            <a href="calendar.cfm?ThisCal=#LastMonth#&func=#url.func#">#DateFormat(LastMonth, "mmm")#</a>
        </td>
        ...
        <td align="center">
            <a href="calendar.cfm?ThisCal=#NextMonth#&func=#url.func#">#DateFormat(NextMonth, "mmm")#</a>
        </td>
    </tr>
    <tr>
...
from master
WHERE actualdate <> null AND actualdate=#parsedatetime(miday2)# and func='#url.func#'
group by actualdate
</cfquery>
<table>
<tr>
<td ><a href="whoismi.cfm?miday3=#miday2#&func=#url.func#">#ThisDay#</a></td>
</tr>
