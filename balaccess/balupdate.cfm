...
<meta http-equiv="refresh" content="0;URL=functiondata2.cfm?ID=#form.ID#&error=13&name=#form.name#&actual=#form.actual#">
<cfexit>
</cfif>
<!--------------------------------------FIRST IF-------------------------------------------------------->
...
<meta http-equiv="refresh" content="0;URL=functiondata2.cfm?ID=#form.ID#&error=14&name=#form.name#&actual=#form.actual#&odate=#form.odate#&osession=#form.osession#">
<cfexit>
</cfif>
...
UPDATE master SET loc='#form.loc#', flr='#form.flr#', office='#form.office#',ph='#form.ph#', wrkhrs='#form.wrkhrs#', blkberry='#form.blkberry#', mtype='#form.mtype#', dispo='#form.dispo#', itemdesc='#form.desc#', serial='#form.serial#', replacemodel='#form.model#', status='#form.status#', midate='#form.actual#', actualdate='#form.actual#', stime='#form.time#', comment='#form.comment#' Where ID=#form.ID#
</cfquery>
<cfmail from="DSI Webpage Scheduler" to="glen.radziminski@ny.frb.org,ny.dsi.migration.scheduler@ny.frb.org" subject="User #Form.name# has been Scheduled to Migrate">

The following User has been Scheduled to Migrate
...
Status: #form.status#
Date and Time: #dateformat(form.actual,'m/d/yyyy')#  #timeformat(form.time,'h:mm tt')#
</cfmail>
...
<meta http-equiv="refresh" content="0;URL=functiondata2.cfm?ID=#form.ID#&error=15&name=#form.name#&actual=#form.actual#&odate=#form.odate#&osession=#form.osession#">
<cfexit>
...
<cfmail from="DSI Webpage Scheduler" to="Nancy.Bailey@ny.frb.org,Pamela.Andrews@ny.frb.org,Patricia.Gordon@ny.frb.org,Louis.Bryan@ny.frb.org"  subject="User #Form.name# has been Scheduled">
...
Function: #form.funcname#
Location: #form.loc#
Date and Session: #dateformat(form.odate,'m/d/yyyy')#  #form.osession#
</cfmail>
...
<br>
<meta http-equiv="refresh" content="1;URL=functiondata.cfm?lname=#form.lname#&fname=#form.fname#">
<cfexit>
...
<meta http-equiv="refresh" content="0;URL=functiondata2.cfm?ID=#form.ID#&error=16&name=#form.name#&actual=#form.actual#&odate=#form.odate#&osession=#form.osession#">
<cfexit>
</cfif>
...
Function: #form.funcname#
Location: #form.loc#
Date and Session: #dateformat(form.tdate,'m/d/yyyy')#  #form.tsession#
</cfmail>
<span class="style1">Customer #form.name# Updated and Scheduled for XP Training</span>
<br>
<span class="style1">Refeshing Page...Please wait</span>
<meta http-equiv="refresh" content="1;URL=functiondata.cfm?lname=#form.lname#&fname=#form.fname#">
<cfexit>
