...
<div align="center">
                  <p><span class="burgundy"><strong>Welcome<br>
                    Deployment Team </strong></span><span class="burgundy"><strong><br>
                      <strong>What would you like to do today?</strong> </strong></span>                    <br>
                    </p>
                  </div>
                <table width="100%"  border="0" cellpadding="10" cellspacing="10">
                  <tr>
                    <td align="center" valign="top" bgcolor="#eeeeee" class="style2 style4"><strong><a href="team1.cfm" target="_blank">Enter Times</a></strong></td>
                  ...
                  <tr>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee" class="style2 style4"><strong><a href="../viewattach/index.cfm" target="_blank">View Attachment F Pipline </a></strong></td>
                    <td width="50%" align="center" valign="top" bgcolor="#eeeeee" class="style4 style2"><a href="migrations.cfm" target="_blank"><strong>Hard Drive Prep Report</strong></a><strong> </strong></td>
                  </tr>
                </table>
