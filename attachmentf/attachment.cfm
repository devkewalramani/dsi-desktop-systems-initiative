  ...
  <p align="center" class="burgundy"><strong>Attachment F- Customer Migration information Worksheet</strong></p>
    ...
    <table width="100%"  border="0">
      ...
      <tr>
        ...
        <td><input name="bal" type="text" id="bal"></td>
    ...
    <div align="center"><strong class="burgundy">Line of Business Images Required </strong><br>
      <br>
      <input name="func2" type="text" id="func2" value="#attach.func#" readonly="yes">
  </div>
    <hr align="left" width="100%" noshade>  
    <div align="center">
      <p><strong>List Other Department Business Applications Required<br> 
        </strong><span class="style2">(If you do not see applications required for your department on the <em>Line of Business Image Definitions </em>list (Attachment G), please make sure that they are noted below. <strong> <a href="attachmentg.pdf" target="_blank">Click here to view Attachment G</a> <br>
        Identify applications with fewer than 10 licenses which will be installed from CD or network installation directory with an </strong>* in the additonal items field.)
        <br>
        </span>    </p>
      </div>
                  </cfoutput>
      ...
      <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
       ...
       <div align="left">
         ...
         <p align="center"><br>
                      <input type="submit" name="Submit" value="Click to save (This will also be sent to your Business Area Liaison for approval)">
                      </form>
                    </p>
            </p>
       </div>
