...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
  ...
  <form name="Team" method="post" action="record.cfm">
       <p>Select Your Group <br>
	   ...
	   <p>Type in your Last Name<br>
           <input type="test" name="lname" style="background-color:#eeeeee">
       </p>
	   <bt>
