...
<cfoutput>
<cfquery name="updatecust" datasource="DSI">
UPDATE customer SET lname='#form.lname#',fname='#form.fname#',office='#form.office#',func='#form.func#',officer='#form.officer#',bal='#form.bal#',logon='#form.logon#',ph='#form.ph#',mtype='#form.mtype#',status='#form.status#',condata='#form.condata#',s1='#form.s1#',s2='#form.s2#',s3='#form.s3#',s4='#form.s4#',s5='#form.s5#',s6='#form.s6#',s7='#form.s7#',s8='#form.s8#',s9='#form.s9#',s10='#form.s10#',s11='#form.s11#',s12='#form.s12#',s13='#form.s13#',s14='#form.s14#',s15='#form.s15#',s16='#form.s16#',s17='#form.s17#',s18='#form.s18#',s19='#form.s19#',s20='#form.s20#',comment='#form.comment#' Where custid='#form.ID#'
</cfquery>

<cfquery name="updatemaster" datasource="DSI">
UPDATE master SET attachstatus='pendingrevised' WHERE ID=#form.id#
</cfquery>

<cfmail from="DSI WEBSITE" to="dev.kewalramani@ny.frb.org" subject="#form.fname#, #form.lname# has revised an Attachment F">

#form.fname# #form.lname# has revised an Attachment F
...
<meta http-equiv="refresh" content="3;URL=record.cfm?func=#form.func#">
</cfoutput>
