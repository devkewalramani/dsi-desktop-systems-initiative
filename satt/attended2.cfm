...
<cfquery name="updateattendance" datasource="DSI">
UPDATE master SET oattended='#attend#' WHERE ID=#form.ID#
</cfquery>				
...
<cfoutput>
  <p align="center"><span class="style2 style1 burgundy"><strong>FRB NY DSI Project<br>
    SATT Orientation Attendance Form <br>
...
<cfif #oattended# eq "" OR #oattended# eq 'No' >
<form name="form" method="post" action="attended2.cfm">
  ...
  <tr bgcolor=###IIF(attended.currentrow MOD 2,DE ('FFFFFF'),DE ('dddddd'))#>
    ...
    <td><select name="attend">
	  <option value="#oattended#">#oattended#</option>
	  <option value=""></option>
